...
export const themes: Record<ThemeKey, {
  ...
  "material": {
    ...
    storyKey: "Material",
    file: "material.css",
    description: "A cohesive Material 3 recipe with semantic blue roles, tonal surfaces, purposeful shapes, and restrained elevation.",
    tokens: {
      "--jb-primary": "#0b57d0",
...
const customColorTokenDescriptions: Record<string, string> = {
  ...
  "--jb-success": "Positive/status accent for successful actions, confirmations, and status icons.",
  "--jb-primary-container": "Tonal primary container for selected and lower-emphasis active states.",
  "--jb-on-primary": "Text and icon color placed on the primary fill.",
  "--jb-on-primary-container": "Text and icon color placed on the primary tonal container.",
  "--jb-secondary": "Supporting accent for secondary actions and less prominent active states.",
  "--jb-secondary-container": "Tonal container for supporting actions and selected surfaces.",
  "--jb-on-secondary": "Text and icon color placed on the secondary fill.",
  "--jb-on-secondary-container": "Text and icon color placed on the secondary tonal container.",
  "--jb-surface-container-low": "Low-emphasis grouped surface behind cards and controls.",
  "--jb-surface-container": "Default tonal container used to separate grouped content.",
  "--jb-surface-container-high": "Raised tonal surface used by transient or emphasized containers.",
  "--jb-surface-container-highest": "Highest-emphasis tonal surface for disabled fills and strong separation.",
  "--jb-outline": "Higher-emphasis outline for controls and boundaries.",
  "--jb-outline-variant": "Lower-emphasis outline for dividers and subtle containers.",
  "--jb-error": "Semantic error color for validation and destructive states.",
  "--jb-error-container": "Tonal background for error messages and destructive feedback.",
  "--jb-on-error": "Text and icon color placed on the error fill.",
  "--jb-success-container": "Tonal background for positive feedback.",
  "--jb-warning": "Semantic warning accent for attention states.",
  "--jb-warning-container": "Tonal background for warning feedback.",
};
