...
const buildConfigPath = args.path;

const {webComponentList, reactComponentList} = await import(buildConfigPath) as {webComponentList: WebComponentBuildConfig[], reactComponentList:ReactComponentBuildConfig[]};
