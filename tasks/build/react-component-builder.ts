...
//config
import { reactComponentList,type ReactComponentBuildConfig } from '../../config/build-config.ts';
...
export class ReactComponentBuilder {
  ...
  _getOutputOption(module:ReactComponentBuildConfig, format:'umd'|'es'|'cjs') {
  ...
  _getTypeScriptCompilerOptions(module:ReactComponentBuildConfig, externalList:string[]){
