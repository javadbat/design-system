...
<ColorPalette>
  ...
  <ColorItem title="primary" description="" colors={{'main':colors.primary.main,'hover':colors.primary.hover,'pressed':colors.primary.pressed}}/>
  <ColorItem title="secondary" description="" colors={{'main':colors.secondary.main,'hover':colors.secondary.hover,'pressed':colors.secondary.pressed}}/>
