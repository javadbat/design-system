...
const GregorianTestTemplate = (args) => <JBDateInputGregorianTest label={args.label} min={args.min} max={args.max} valueType={args.valueType}></JBDateInputGregorianTest>;
