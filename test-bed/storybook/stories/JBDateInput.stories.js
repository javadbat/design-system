...
const JalaliTestTemplate = (args) => <div style={{direction:'rtl'}}><JBDateInputJalaliTest label={args.label} min={args.min} max={args.max} valueType={args.valueType}></JBDateInputJalaliTest></div>;
