...
- [x] add jb-icon with lots of ready to use icon animation like search, edit, delete,...
- [x] add linting (waiting to see ofc or biome or deno gets viral).
- [x] create mdx file for jb-date-input abilities.
- [x] create web-component table for jb-grid.
