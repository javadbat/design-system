import{i as e}from"./preload-helper-CT_b8DTk.js";import{t}from"./iframe-x2s4iwIh.js";import{d as n,f as r,j as i,y as a}from"./blocks-wp6k7q95.js";import{t as o}from"./mdx-react-shim-BRG_srcz.js";var s,c=e((()=>{s=`# jb-grid

The \`jb-pagination\`, \`jb-pagination-info\`, \`jb-row\`, \`jb-cell\`, \`jb-table-header\`, \`jb-col-header\`, \`jb-grid-layout\`, \`jb-viewport\`, and \`jb-expand-toggle\` elements emit a non-bubbling \`init\` event at the end of connection setup. Attach listeners before inserting elements into the document.
