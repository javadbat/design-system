import{a as e,i as t,s as n}from"./preload-helper-CT_b8DTk.js";import{K as r,t as i}from"./iframe-D4DdPDUe.js";import{r as a,t as o}from"./react-D2SbZDAh.js";var s=e({AttributeAndFormSynchronization:()=>P,ControlledRange:()=>M,CustomStep:()=>b,DecimalStep:()=>y,Disabled:()=>E,InForm:()=>N,MajorAndMinorTicks:()=>S,NegativeMin:()=>O,NegativeRange:()=>k,Normal:()=>h,Range:()=>w,RangeDecimalStep:()=>T,Required:()=>A,SizeVariants:()=>v,StartPoint:()=>g,WithError:()=>j,WithMessage:()=>D,WithTickLabels:()=>x,WithoutBalloonRotation:()=>_,WithoutTickLabels:()=>C,__namedExportsOrder:()=>F,default:()=>m});function c(e){let t=(0,u.useRef)(null);return(0,u.useEffect)(()=>{t.current?.reportValidity()},[]),(0,d.jsx)(a,{...e,ref:t})}function l(){let[e,t]=(0,u.useState)([2,8]);return(0,d.jsxs)(`div`,{children:[(0,d.jsx)(a,{mode:`range`,min:0,max:10,value:e,onChange:e=>t(e.currentTarget.value)}),(0,d.jsxs)(`output`,{children:[`Selected range: `,Array.isArray(e)?e.join(` - `):e]})]})}var u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I=t((()=>{u=n(r(),1),o(),d=i(),{expect:f,waitFor:p}=__STORYBOOK_MODULE_TEST__,m={title:`Components/form elements/JBRangeInput`,component:a,decorators:[e=>(0,d.jsx)(`div`,{style:{marginBlock:`4rem`},children:(0,d.jsx)(e,{})})],args:{label:`Range value`,min:0,max:10,step:1,tickStep:1,startPoint:0},argTypes:{label:{control:`text`},min:{control:`number`},max:{control:`number`},step:{control:`number`},tickStep:{control:`number`},startPoint:{control:`number`},minorTickStep:{control:`number`},showTickLabels:{control:`boolean`},disableBalloonRotation:{control:`boolean`},size:{control:`inline-radio`,options:[`xs`,`sm`,`md`,`lg`,`xl`]},mode:{control:`inline-radio`,options:[`single`,`range`]},disabled:{control:`boolean`},required:{control:`boolean`},message:{control:`text`},error:{control:`text`}}},h={play:async({canvasElement:e})=>{let t=e.querySelector(`jb-range-input`),n=t.shadowRoot.querySelector(`[part='label']`),r=t.shadowRoot.querySelector(`[part='range']`),i=t.shadowRoot.querySelector(`[part~='range-handle']`);await p(()=>f(n.textContent).toBe(`Range value`)),f(r.getAttribute(`aria-labelledby`)).toBe(`range-label`),n.click(),f(t.shadowRoot.activeElement).toBe(i)}},g={name:`Start Point`,args:{min:-10,max:20,step:5,startPoint:-5,value:10},play:async({canvasElement:e})=>{let t=e.querySelector(`jb-range-input`),n=t.shadowRoot.querySelector(`[part='range-active-line']`),r=t.shadowRoot.querySelector(`[part='range-line']`);await p(()=>f(t.getAttribute(`start-point`)).toBe(`-5`)),f(t.value).toBe(10);let i=Number(r.getAttribute(`x1`)),a=i+5/30*(Number(r.getAttribute(`x2`))-i);f(Number(n.getAttribute(`x1`))).toBeCloseTo(a,5)}},_={args:{value:5,disableBalloonRotation:!0}},v={args:{tickStep:5,value:5,showTickLabels:!0},render:e=>(0,d.jsx)(`div`,{style:{display:`grid`,gap:`2rem`},children:[`xs`,`sm`,`md`,`lg`,`xl`].map(t=>(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{children:t}),(0,d.jsx)(a,{...e,size:t})]},t))})},y={args:{max:3,step:.1,tickStep:1,value:1.2}},b={args:{max:50,step:5,tickStep:5,value:10}},x={args:{max:100,step:5,tickStep:25,showTickLabels:!0,value:50}},S={args:{max:100,step:5,tickStep:25,minorTickStep:5,showTickLabels:!0,tickLabelFormatter:e=>`${e}%`,value:50}},C={args:{max:100,tickStep:25,value:50}},w={args:{mode:`range`,value:[2,8]}},T={args:{mode:`range`,value:[2,8],step:.1}},E={args:{value:4,disabled:!0},play:async({canvasElement:e})=>{let t=e.querySelector(`jb-range-input`),n=t.shadowRoot.querySelector(`.range-handle`);await p(()=>f(t.disabled).toBe(!0)),f(t.hasAttribute(`disabled`)).toBe(!0),f(n.getAttribute(`tabindex`)).toBe(`-1`),n.dispatchEvent(new KeyboardEvent(`keydown`,{key:`ArrowRight`,bubbles:!0})),f(t.value).toBe(4)}},D={args:{value:4,message:`Choose a value between 0 and 10`}},O={args:{min:-10,max:10,value:-4}},k={args:{mode:`range`,min:-100,max:100,step:10,tickStep:20,value:[-40,60]}},A={args:{name:`score`,required:!0,message:`Select a score`},render:e=>(0,d.jsxs)(`form`,{onSubmit:e=>e.preventDefault(),children:[(0,d.jsx)(`p`,{id:`required-range-label`,children:`Required score`}),(0,d.jsx)(a,{...e,"aria-labelledby":`required-range-label`}),(0,d.jsx)(`button`,{type:`submit`,children:`Submit`})]})},j={args:{value:4,message:`Choose a value between 0 and 10`,error:`This value is not available`},render:e=>(0,d.jsx)(c,{...e})},M={render:()=>(0,d.jsx)(l,{})},N={render:()=>(0,d.jsxs)(`form`,{onSubmit:e=>{e.preventDefault();let t=new FormData(e.currentTarget);alert(`Submitted price: ${t.get(`price`)}`)},children:[(0,d.jsx)(`p`,{id:`price-range-label`,children:`Price range`}),(0,d.jsx)(a,{"aria-labelledby":`price-range-label`,name:`price`,mode:`range`,min:0,max:100,step:5,initialValue:[20,80]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`button`,{type:`reset`,children:`Reset`}),(0,d.jsx)(`button`,{type:`submit`,children:`Submit`})]})]})},P={render:()=>(0,d.jsx)(`div`,{dangerouslySetInnerHTML:{__html:`<form><jb-range-input name="range" value="2,8" mode="range"></jb-range-input></form>`}}),play:async({canvasElement:e})=>{let t=e.querySelector(`form`),n=t.querySelector(`jb-range-input`);await p(()=>f(n.value).toEqual([2,8])),n.setAttribute(`max`,`5`),f(n.value).toEqual([2,5]),f(n.getAttribute(`value`)).toBe(`2,5`),f(new FormData(t).get(`range`)).toBe(`2,5`),n.setAttribute(`mode`,`single`),f(n.value).toBe(5),f(new FormData(t).get(`range`)).toBe(`5`)}},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
...
}`,...P.parameters?.docs?.source}}},F=[`Normal`,`StartPoint`,`WithoutBalloonRotation`,`SizeVariants`,`DecimalStep`,`CustomStep`,`WithTickLabels`,`MajorAndMinorTicks`,`WithoutTickLabels`,`Range`,`RangeDecimalStep`,`Disabled`,`WithMessage`,`NegativeMin`,`NegativeRange`,`Required`,`WithError`,`ControlledRange`,`InForm`,`AttributeAndFormSynchronization`]}));I();export{P as AttributeAndFormSynchronization,M as ControlledRange,b as CustomStep,y as DecimalStep,E as Disabled,N as InForm,S as MajorAndMinorTicks,O as NegativeMin,k as NegativeRange,h as Normal,w as Range,T as RangeDecimalStep,A as Required,v as SizeVariants,g as StartPoint,j as WithError,D as WithMessage,x as WithTickLabels,_ as WithoutBalloonRotation,C as WithoutTickLabels,F as __namedExportsOrder,m as default,I as n,s as t};