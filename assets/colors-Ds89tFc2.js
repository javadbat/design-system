import{i as e}from"./preload-helper-CT_b8DTk.js";import{t}from"./iframe-Cke0LeCu.js";import{A as n,d as r,h as i,i as a,l as o,r as s,v as c}from"./blocks-DDo4t-fV.js";import{t as l}from"./mdx-react-shim-BCxdF7rO.js";import{n as u,t as d}from"./dist-CWlHNo2l.js";function f(e){let t={br:`br`,code:`code`,h2:`h2`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(r,{title:`Theme/Colors`}),`
`,(0,m.jsx)(o,{children:`Color Palette`}),`
`,(0,m.jsx)(i,{children:`all color are based on oklch() color space`}),`
`,(0,m.jsx)(`br`,{}),`
`,(0,m.jsxs)(a,{children:[(0,m.jsx)(s,{title:`single`,subtitle:`--jb-black,--jb-white,--jb-highlight`,colors:{black:d.single.black.value,white:d.single.white.value,highlight:d.single.highlight.value}}),(0,m.jsx)(s,{title:`neutral`,subtitle:`--jb-neutral,--jb-neutral-[index]`,colors:{main:d.neutral[0].value,d1:d.neutral[1].value,d2:d.neutral[2].value,d3:d.neutral[3].value,d4:d.neutral[4].value,d5:d.neutral[5].value,d6:d.neutral[6].value,d7:d.neutral[7].value,d8:d.neutral[8].value,d9:d.neutral[9].value,d10:d.neutral[10].value}}),(0,m.jsx)(s,{title:`primary`,subtitle:`--jb-primary,--jb-primary-[name]`,colors:{main:d.primary.main.value,"l(lighter)":d.primary.light.value,"d(dark)":d.primary.dark.value,subtle:d.primary.subtle.value,contrast:d.primary.contrast.value,hover:d.primary.hover.value,pressed:d.primary.pressed.value}}),(0,m.jsx)(s,{title:`secondary`,subtitle:`--jb-secondary,--jb-secondary-[name]`,colors:{main:d.secondary.main.value,"l(lighter)":d.secondary.light.value,"d(dark)":d.secondary.dark.value,subtle:d.secondary.subtle.value,contrast:d.secondary.contrast.value,hover:d.secondary.hover.value,pressed:d.secondary.pressed.value}}),(0,m.jsx)(s,{title:`success`,subtitle:`--jb-green,--jb-green-[name]`,colors:{main:d.green.main.value,"l(lighter)":d.green.light.value,"d(dark)":d.green.dark.value,subtle:d.green.subtle.value,contrast:d.green.contrast.value,hover:d.green.hover.value,pressed:d.green.pressed.value}}),(0,m.jsx)(s,{title:`error`,subtitle:`--jb-red,--jb-red-[name]`,colors:{main:d.red.main.value,"l(lighter)":d.red.light.value,"d(dark)":d.red.dark.value,subtle:d.red.subtle.value,contrast:d.red.contrast.value,hover:d.red.hover.value,pressed:d.red.pressed.value}}),(0,m.jsx)(s,{title:`warning`,subtitle:`--jb-yellow,--jb-yellow-[name]`,colors:{main:d.yellow.main.value,"l(lighter)":d.yellow.light.value,"d(dark)":d.yellow.dark.value,subtle:d.yellow.subtle.value,contrast:d.yellow.contrast.value,hover:d.yellow.hover.value,pressed:d.yellow.pressed.value}})]}),`
...
`,`this method currently only support `,(0,m.jsx)(t.code,{children:`JBColorGroup`}),` color types. for single or neutral colors just use css variables.`]})]})}function p(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,m.jsx)(t,{...e,children:(0,m.jsx)(f,{...e})}):f(e)}var m;e((()=>{m=t(),l(),c(),u()}))();export{p as default};