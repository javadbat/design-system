import{i as e}from"./preload-helper-CT_b8DTk.js";import{t}from"./iframe-DRUIHCJR.js";import{f as n,h as r,j as i,p as a,v as o,y as s}from"./blocks-DhrBk0Pl.js";import{t as c}from"./mdx-react-shim-Ne3X4DXq.js";import{HashIdAndAutoClose as l,n as u}from"./JBModal.stories-8rRCPkjZ.js";function d(e){let t={code:`code`,h2:`h2`,li:`li`,p:`p`,pre:`pre`,ul:`ul`,...i(),...e.components};return(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(n,{title:`Components/JBModal/Hash Id`}),`
`,(0,p.jsx)(o,{children:`Hash Id`}),`
...
`,(0,p.jsx)(r,{of:l,inline:!1,height:`32rem`}),`
`,(0,p.jsx)(a,{of:l}),`
...
`,(0,p.jsxs)(t.li,{children:[`When the modal is initialized while `,(0,p.jsx)(t.code,{children:`location.hash`}),` already matches the modal id, the modal opens itself and dispatches `,(0,p.jsx)(t.code,{children:`url-open`}),`.`]}),`
`,(0,p.jsxs)(t.li,{children:[`When `,(0,p.jsx)(t.code,{children:`close()`}),` runs while the current hash is `,(0,p.jsx)(t.code,{children:`#id`}),`, the modal navigates back when it owns that history entry, so the previous hash is restored.`]}),`
`]}),`
...
`,(0,p.jsxs)(t.p,{children:[(0,p.jsx)(t.code,{children:`ESCAPE_KEY`}),` means the user pressed Escape while the modal was topmost.`]}),`
`,(0,p.jsx)(t.h2,{id:`auto-close`,children:`Auto close`}),`
`,(0,p.jsx)(t.p,{children:`Auto close is a direct property on the web component and a direct prop on the React wrapper:`}),`
`,(0,p.jsx)(t.pre,{children:(0,p.jsx)(t.code,{className:`language-tsx`,children:`<JBModal
  id="HashLinkedModal"
  isOpen={isOpen}
...
`,(0,p.jsx)(t.p,{children:`In Storybook, browser-back behavior is easiest to test in the isolated iframe view because the story is normally nested inside Storybook's manager UI.`}),`
`,(0,p.jsx)(t.h2,{id:`nested-modal-history`,children:`Nested modal history`}),`
`,(0,p.jsxs)(t.p,{children:[`Give each history-linked modal a unique `,(0,p.jsx)(t.code,{children:`id`}),`. If modal A opens modal B, the browser entries are:`]}),`
`,(0,p.jsx)(t.pre,{children:(0,p.jsx)(t.code,{className:`language-text`,children:`/page -> #modal-a -> #modal-b
`})}),`
`,(0,p.jsxs)(t.p,{children:[`Back closes B and restores `,(0,p.jsx)(t.code,{children:`#modal-a`}),`; another Back closes A. Only the topmost modal reacts to each history change.`]}),`
`,(0,p.jsxs)(t.p,{children:[`A direct load at `,(0,p.jsx)(t.code,{children:`#modal-b`}),` can open B, but the hash does not contain enough information to reconstruct modal A. Applications that require parent context must restore it themselves.`]})]})}function f(e={}){let{wrapper:t}={...i(),...e.components};return t?(0,p.jsx)(t,{...e,children:(0,p.jsx)(d,{...e})}):d(e)}var p;e((()=>{p=t(),c(),s(),u()}))();export{f as default};