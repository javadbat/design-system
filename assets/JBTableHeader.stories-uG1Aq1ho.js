import{i as e}from"./preload-helper-CT_b8DTk.js";import{t}from"./iframe-CJEKjAwU.js";import{i as n,n as r,t as i}from"./react-BYCUUT9P.js";var a,o,s,c,l,u,d;e((()=>{i(),a=t(),{expect:o,waitFor:s}=__STORYBOOK_MODULE_TEST__,c=[{name:`id`,size:`5rem`},{name:`name`,size:`1fr`},{name:`family`,size:`1fr`},{name:`age`,size:`6.25rem`}],l={title:`Components/JBGrid/TableHeader`,component:n},u={args:{headerTemplate:c,children:(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(r,{name:`id`,children:`ID`}),(0,a.jsx)(r,{name:`name`,sortable:!0,children:`Name`}),(0,a.jsx)(r,{name:`family`,sortable:!0,children:`Family`}),(0,a.jsx)(r,{name:`age`,children:`Age`})]})},play:async({canvasElement:e})=>{let t=e.querySelector(`jb-table-header`);o(t).toBeTruthy(),o(t?.headerTemplate).toEqual(c);let n=t?.shadowRoot?.querySelector(`.table-header-row`);o(n?.getAttribute(`role`)).toBe(`row`),o(Array.from(t?.querySelectorAll(`jb-col-header`)??[]).map(e=>e.getAttribute(`name`))).toEqual([`id`,`name`,`family`,`age`]),await s(()=>{let e=t?.shadowRoot?.adoptedStyleSheets[0];o(Array.from(e?.cssRules??[]).map(e=>e.cssText).join(` `)).toContain(`grid-template-columns: 5rem 1fr 1fr 6.25rem`)})}},u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  args: {
    headerTemplate,
    children: <>
