import{i as e}from"./preload-helper-CT_b8DTk.js";import{t}from"./iframe-x2s4iwIh.js";import{d as n,f as r,j as i,y as a}from"./blocks-wp6k7q95.js";import{t as o}from"./mdx-react-shim-BRG_srcz.js";var s,c=e((()=>{s=`# jb-grid React component
...
The custom-element wrappers use \`useDirectProps\` to apply props after the element's \`init\` event. This includes pagination, pagination info, rows, cells, headers, layout, viewport, expand toggles, and the refresh/fullscreen icons. Each accepts \`ref\` as a prop and an optional \`onInit\` callback. Children remain mounted while other props wait for initialization. Existing sorting and page-size callbacks and prop defaults are preserved.
