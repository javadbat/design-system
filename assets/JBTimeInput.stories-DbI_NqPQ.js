import{r,R as e}from"./index-CwcVQgaJ.js";import{a as G}from"./JBTimeInput-BKhmddoQ.js";import"./jb-time-picker-DrGx2sjJ.js";import"./index-C0u5HlS_.js";import"./jb-validation-DEeh0jn_.js";import"./index-BtFglznY.js";import"./index-bfIR6bpK.js";import"./index-_b1slotr.js";import"./jb-popover-D5-NAHSt.js";import"./index-BVrqzDik.js";function H(E){const a=r.useRef(),[t,n]=r.useState();return e.createElement("div",null,e.createElement(G,{ref:a,label:"date",value:t,onChange:b=>n(b.target.value)}),e.createElement("span",null,"value:",t),e.createElement("br",null),e.createElement("button",{onClick:()=>n("12:48:00")},"set value to 12:48"),e.createElement("button",{onClick:()=>n("00:00:00")},"set value to 00:00"))}H.propTypes={};function K(E){const a=r.useRef(),t=r.useRef(),[n,b]=r.useState(),[Q,X]=r.useState();return r.useEffect(()=>{a.current&&a.current.addEventListener("change",v=>{b(v.target.value)})},[a.current]),r.useEffect(()=>{t.current&&(t.current.addEventListener("change",v=>{X(v.target.value)}),t.current.secondEnabled=!1)},[t.current]),e.createElement("div",null,e.createElement("jb-time-input",{ref:a,label:"date"}),e.createElement("span",null,"value:",n),e.createElement("h3",null,"without second"),e.createElement("jb-time-input",{ref:t}),e.createElement("span",null,"value:",Q))}K.propTypes={};const me={title:"Components/form elements/Inputs/JBTimeInput",component:G},s={args:{label:"time"}},o={args:{label:"time",showPersianNumber:!0}},l={args:{label:"time",value:"13:24:48"}},u={args:{label:"زمان",closeButtonText:"بستن"},parameters:{themes:{themeOverride:"rtl"}}},m={render:()=>e.createElement(K,null)},c={render:()=>e.createElement(H,null)},i={args:{label:"time:",validationList:[{validator:/^[1][1234].*$/g,message:"hour  must be between 11 and 14"},{validator:({displayValue:E,value:a,valueObject:t})=>!(t.minute&&t.minute<30),message:"minute must be 30 to 60"}]}},p={args:{label:"time",secondEnabled:!1}},d={args:{label:"time",closeButtonText:"بستن",frontalZero:!0}},g={args:{label:"زمان",closeButtonText:"بستن",optionalUnits:["minute"]}};var f,T,S;s.parameters={...s.parameters,docs:{...(f=s.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
    label: 'time'
  }
