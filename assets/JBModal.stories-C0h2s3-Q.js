var $=Object.defineProperty;var B=n=>{throw TypeError(n)};var G=(n,e,t)=>e in n?$(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var O=(n,e,t)=>G(n,typeof e!="symbol"?e+"":e,t),y=(n,e,t)=>e.has(n)||B("Cannot "+t);var r=(n,e,t)=>(y(n,e,"read from private field"),t?t.call(n):e.get(n)),c=(n,e,t)=>e.has(n)?B("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(n):e.set(n,t),d=(n,e,t,s)=>(y(n,e,"write to private field"),s?s.call(n,t):e.set(n,t),t),M=(n,e,t)=>(y(n,e,"access private method"),t);import{R as o,r as a}from"./index-DP23ewiS.js";import{j as P}from"./index-DA-aheCX.js";import{r as h}from"./index-DGoq4Khl.js";import{o as E}from"./JBButton-B41CN8pt.js";import"./jb-loading-Bke36SbW.js";var l,i,m,C,Y,x,F=(x=class extends HTMLElement{constructor(){super();c(this,C);c(this,l,!1);c(this,i);c(this,m,"");O(this,"elements");O(this,"config",{autoCloseOnBackgroundClick:!1});this.initWebComponent()}get id(){const e=this.getAttribute("id")||"";return r(this,m)||e}set id(e){d(this,m,e),this.checkInitialOpenness()}get isOpen(){return r(this,l)}connectedCallback(){this.callOnLoadEvent(),this.initProp(),this.callOnInitEvent()}callOnLoadEvent(){const e=new CustomEvent("load",{bubbles:!0,composed:!0});this.dispatchEvent(e)}callOnInitEvent(){const e=new CustomEvent("init",{bubbles:!0,composed:!0});this.dispatchEvent(e)}initWebComponent(){const e=this.attachShadow({mode:"open"});d(this,i,this.attachInternals()),r(this,i).ariaModal="true",P();const t=document.createElement("template");t.innerHTML=`<style>.jb-modal-web-component{z-index:var(--z-index);width:100%;height:100%;position:fixed;top:0;left:0}.jb-modal-web-component.--closed{display:none}@media (max-width:768px){.jb-modal-web-component.--closed .modal-content-wrapper{transform:translateY(100%)}}.jb-modal-web-component.--opened{display:block}@media (max-width:768px){.jb-modal-web-component.--opened .modal-content-wrapper{animation-name:swipe-up;animation-duration:.3s;animation-timing-function:ease;animation-iteration-count:1;animation-delay:0s}}.jb-modal-web-component .modal-background{background-color:var(--back-bg-color);backdrop-filter:blur(10px);z-index:2;width:100%;height:100%;position:absolute;top:0;left:0}.jb-modal-web-component .modal-content-wrapper{z-index:3;pointer-events:none;justify-content:center;align-items:center;width:100%;height:100%;display:flex;position:absolute;top:0;left:0}@media (max-width:768px){.jb-modal-web-component .modal-content-wrapper{bottom:0;top:initial;align-items:flex-end}}.jb-modal-web-component .modal-content-wrapper .modal-content{pointer-events:all;background-color:var(--bg-color);border-radius:var(--border-radius);width:auto;height:auto}@media (max-width:768px){.jb-modal-web-component .modal-content-wrapper .modal-content{border-radius:var(--border-radius)var(--border-radius)0 0;width:100%;height:auto;min-height:32px;max-height:calc(100% - 80px);overflow-y:auto}}@keyframes swipe-up{0%{transform:translateY(100%)}to{transform:translateY(0%)}} :host{--z-index:var(--jb-modal-z-index,1);--border-radius:var(--jb-modal-border-radius,var(--jb-radius-xl));--back-bg-color:var(--jb-modal-back-bg-color,oklch(from var(--jb-white)l c h/.1));--bg-color:var(--jb-modal-bg-color,var(--jb-white))}</style>
