import{a as e,i as t,s as n}from"./preload-helper-CT_b8DTk.js";import{ot as r,t as i}from"./iframe-B40dur4B.js";import{r as a,t as o}from"./react-DKs-OYJ9.js";import{a as s,t as c}from"./react-CDLu0_kP2.js";var l=t((()=>{}));function u(e,t=0){let n=e.querySelectorAll(`jb-input`)[t];return m(n).toBeTruthy(),m(n.shadowRoot).toBeTruthy(),n}function d(e){let t=e.shadowRoot?.querySelector(`input`);return m(t).toBeTruthy(),t}function f(e){return e.shadowRoot?.querySelector(`.message-box`)?.textContent??``}function p(e){let t=e.shadowRoot?.querySelector(`.input-box`);return m(t).toBeTruthy(),t}var m,h=t((()=>{({expect:m}=__STORYBOOK_MODULE_TEST__)})),g=e({CustomMobileKeyboard:()=>V,Disabled:()=>D,LargeText:()=>F,Normal:()=>T,OnEnterTest:()=>P,Required:()=>E,RequiredWithCustomMessage:()=>k,RequiredWithLabel:()=>O,SizeVariants:()=>M,ValidationList:()=>L,WithEndSection:()=>z,WithError:()=>A,WithPlaceholder:()=>j,WithStartAndEndSection:()=>B,WithStartSection:()=>R,__namedExportsOrder:()=>H,default:()=>w,testActions:()=>N,testStyles:()=>I}),_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U=t((()=>{_=n(r(),1),c(),o(),l(),h(),v=i(),{expect:y,fn:b,userEvent:x,waitFor:S,within:C}=__STORYBOOK_MODULE_TEST__,w={title:`Components/form elements/Inputs/JBInput`,component:s},T={args:{label:`label`,message:`static text under input show all the time`,placeholder:`placeholder`,disabled:!1}},E={args:{message:`focus on input write nothing then unfocus(blur) the input and see error message. then write something to make message disappear`,required:!0}},D={args:{label:`disabled input`,message:`static text under input show all the time`,value:`value`,disabled:!0},play:async({canvasElement:e})=>{let t=u(e),n=d(t),r=b();t.addEventListener(`input`,r),await S(()=>{y(t.disabled).toBe(!0),y(n.disabled).toBe(!0),y(n.value).toBe(`value`)}),t.focus(),await x.click(n),await x.type(n,` updated`),y(n.value).toBe(`value`),y(t.value).toBe(`value`),y(r).not.toHaveBeenCalled()}},O={args:{label:`name`,message:`focus on input write nothing then unfocus(blur) the input and see error message. then write something to make message disappear`,required:!0}},k={args:{label:`Required with custom message`,message:`focus on input write nothing then unfocus(blur) the input and see error message. then write something to make message disappear`,required:`you must fill this field to continue`},play:async({canvasElement:e,args:t})=>{let n=u(e);y(n.reportValidity()).toBe(!1),await S(()=>{y(f(n)).toBe(t.required),y(n.hasState(`invalid`)).toBe(!0)}),n.value=`filled`,y(n.reportValidity()).toBe(!0),await S(()=>{y(f(n)).toBe(t.message),y(n.hasState(`invalid`)).toBe(!1)})}},A={args:{label:`has error message`,message:`simple hint message`,error:`error message`,validationList:[{validator:/^.{3,}$/g,message:`you must enter at least 3 characters`}],type:`password`},play:async({canvasElement:e,args:t})=>{let n=u(e);await S(()=>{y(n.reportValidity()).toBe(!1),y(f(n)).toBe(t.error)}),n.value=`ab`,n.setAttribute(`error`,``),await S(()=>{y(n.reportValidity()).toBe(!1),y(f(n)).toBe(`you must enter at least 3 characters`),y(n.hasState(`invalid`)).toBe(!0)}),n.value=`abcd`,y(n.reportValidity()).toBe(!0),await S(()=>{y(f(n)).toBe(t.message),y(n.hasState(`invalid`)).toBe(!1)})}},j={args:{label:`with placeholder`,placeholder:`test placeholder`}},M={render:()=>(0,v.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`1fr 1fr 1fr`,gap:`1rem`},children:[(0,v.jsx)(s,{label:`xl size`,message:`message underneath`,size:`xl`}),(0,v.jsx)(s,{label:`xl size`,placeholder:`placeholder`,size:`xl`}),(0,v.jsx)(s,{label:`xl size`,value:`Value 1234`,size:`xl`}),(0,v.jsx)(s,{label:`lg size`,message:`message underneath`,size:`lg`}),(0,v.jsx)(s,{label:`lg size`,placeholder:`placeholder`,size:`lg`}),(0,v.jsx)(s,{label:`lg size`,value:`Value 1234`,size:`lg`}),(0,v.jsx)(s,{label:`md size`,message:`message underneath`,size:`md`}),(0,v.jsx)(s,{label:`md size`,placeholder:`placeholder`,size:`md`}),(0,v.jsx)(s,{label:`md size`,value:`Value 1234`,size:`md`}),(0,v.jsx)(s,{label:`sm size`,message:`message underneath`,size:`sm`}),(0,v.jsx)(s,{label:`sm size`,placeholder:`placeholder`,size:`sm`}),(0,v.jsx)(s,{label:`sm size`,value:`Value 1234`,size:`sm`}),(0,v.jsx)(s,{label:`xs size`,message:`message underneath`,size:`xs`}),(0,v.jsx)(s,{label:`xs size`,placeholder:`placeholder`,size:`xs`}),(0,v.jsx)(s,{label:`xs size`,value:`Value 1234`,size:`xs`})]})},N={render:()=>{let e=(0,_.useRef)(null),[t,n]=(0,_.useState)(`09`);return(0,_.useEffect)(()=>{e.current?.focus()},[]),(0,v.jsxs)(`div`,{children:[(0,v.jsx)(s,{ref:e,value:t,onKeyup:e=>n(e.target.value),onKeydown:e=>{console.log(e)},label:`type value`,message:`native input and JB Input value must be sync`}),(0,v.jsx)(`br`,{}),(0,v.jsx)(`span`,{children:`value:`}),(0,v.jsx)(`input`,{"data-testid":`mirror-input`,value:t,onChange:e=>n(e.target.value)})]})},play:async({canvasElement:e})=>{let t=u(e),n=d(t),r=C(e).getByTestId(`mirror-input`);await S(()=>{y(n.value).toBe(`09`),y(r.value).toBe(`09`)}),await x.click(r),await x.keyboard(`{Control>}a{/Control}{Backspace}`),await x.type(r,`12345`),await S(()=>{y(t.value).toBe(`12345`),y(n.value).toBe(`12345`)}),n.focus(),await x.keyboard(`{Control>}a{/Control}{Backspace}`),await x.type(n,`678`),await S(()=>{y(t.value).toBe(`678`),y(r.value).toBe(`678`)})}},P={args:{label:`enter test`,message:`Press Enter to see alert`,onEnter:b()},play:async({canvasElement:e,args:t})=>{let n=d(u(e));n.focus(),n.dispatchEvent(new KeyboardEvent(`keyup`,{key:`Enter`,keyCode:13,bubbles:!0,composed:!0})),await S(()=>{y(t.onEnter).toHaveBeenCalled()})}},F={args:{label:`large text to test what will happen if we set long text as an label to input`,message:`long message text to test what happen we we set long message as an message prop. you can also try responsiveness control to see what happen in mobile or tablet size`}},I={render:()=>(0,v.jsxs)(`div`,{className:`jb-input-styling-test`,children:[(0,v.jsx)(`h1`,{children:`JBInput different Styling test`}),(0,v.jsx)(`div`,{className:`cloudy-style`,children:(0,v.jsx)(s,{})}),(0,v.jsx)(`a`,{href:`https://github.com/javadbat/jb-input/blob/main/stories/styles/styles.css`,target:`_blank`,rel:`noopener`,children:`see css styles here`})]})},L={render:e=>{let t=[{validator:e.inputRegex,message:e.inputMessage}],n=[{validator:e.passwordRegex,message:e.passwordMessage}],r=[{validator:e.emailRegex,message:e.emailMessage},{validator:({displayValue:e,value:t})=>t.includes(`yahoo`)?`you cant enter yahoo email9`:!0,message:`email must be gmail`},{validator:({displayValue:e,value:t})=>new Promise(e=>{setTimeout(()=>{t.includes(`outlook`)&&e(`you cant enter outlook email`),e(!0)},3e3)}),message:`outlook doesn't respond`,defer:!0}],i=[{validator:e.mobileRegex,message:e.mobileMessage}],o=(0,_.useRef)(null);function c(){o.current&&console.log(o.current.validation.result)}return(0,v.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`0.5rem`},children:[(0,v.jsx)(s,{label:`input`,validationList:t}),(0,v.jsx)(s,{label:`email`,validationList:r,message:`enter outlook and see async validation result after 3sec`}),(0,v.jsx)(s,{label:`phone number`,validationList:i,message:`you can use jb-mobile-input for better experience`}),(0,v.jsx)(s,{ref:o,label:`password`,validationList:n}),(0,v.jsx)(a,{onClick:c,children:`log password validation(see console)`})]})},args:{inputRegex:/^.{8,}$/g,inputMessage:`you must enter 8 char at least`,passwordRegex:/^(?=.*?[a-z])(?=.*?[0-9]).{8,}$/g,passwordMessage:`password must include one word one number and at least 8 char long`,emailRegex:/^[^\s@]+@[^\s@]+\.[^\s@]+$/g,emailMessage:`email is not valid`,mobileRegex:/^(\+98|0|0098)?9\d{9}$/g,mobileMessage:`mobile number is not valid`},play:async({canvasElement:e})=>{let t=u(e),n=d(t);await x.type(n,`short`),n.blur(),await S(()=>{y(t.reportValidity()).toBe(!1),y(f(t)).toBe(`you must enter 8 char at least`),y(t.hasState(`invalid`)).toBe(!0)}),n.focus(),await x.keyboard(`{Control>}a{/Control}{Backspace}`),await x.type(n,`long-enough`),await S(()=>{y(t.reportValidity()).toBe(!0),y(t.hasState(`invalid`)).toBe(!1)})}},R={args:{label:`label`,message:`static text under input show all the time`,placeholder:`place holder`,children:(0,v.jsx)(`div`,{slot:`start-section`,style:{width:`24px`,height:`24px`,backgroundColor:`#262626`}})}},z={args:{label:`label`,message:`static text under input show all the time`,placeholder:`place holder`,children:(0,v.jsx)(`div`,{slot:`end-section`,style:{width:`24px`,height:`24px`,backgroundColor:`#262626`}})}},B={args:{label:`label`,message:`static text under input show all the time`,placeholder:`place holder`,children:(0,v.jsxs)(_.Fragment,{children:[(0,v.jsx)(`div`,{slot:`end-section`,style:{width:`24px`,height:`24px`,backgroundColor:`#262626`}}),(0,v.jsx)(`div`,{slot:`start-section`,style:{width:`24px`,height:`24px`,backgroundColor:`#262626`}})]})}},V={args:{label:`number keyboard`,inputmode:`numeric`},play:async({canvasElement:e})=>{let t=u(e),n=d(t),r=p(t);await S(()=>{y(n.inputMode).toBe(`numeric`),y(r).toBeTruthy()})}},T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  args: {
    label: 'label',
...
}`,...V.parameters?.docs?.source}}},H=[`Normal`,`Required`,`Disabled`,`RequiredWithLabel`,`RequiredWithCustomMessage`,`WithError`,`WithPlaceholder`,`SizeVariants`,`testActions`,`OnEnterTest`,`LargeText`,`testStyles`,`ValidationList`,`WithStartSection`,`WithEndSection`,`WithStartAndEndSection`,`CustomMobileKeyboard`]}));U();export{V as CustomMobileKeyboard,D as Disabled,F as LargeText,T as Normal,P as OnEnterTest,E as Required,k as RequiredWithCustomMessage,O as RequiredWithLabel,M as SizeVariants,L as ValidationList,z as WithEndSection,A as WithError,j as WithPlaceholder,B as WithStartAndEndSection,R as WithStartSection,H as __namedExportsOrder,w as default,U as n,g as t,N as testActions,I as testStyles};