import{a as e,i as t,s as n}from"./preload-helper-CT_b8DTk.js";import{K as r,t as i}from"./iframe-D24fxiES.js";import{r as a,t as o}from"./react-Dypl6OZe.js";import{r as s,t as c}from"./react-Bu0CCl-a.js";import{n as l,t as u}from"./JBPinInputStyleTest-Cifn5E-u.js";function d(e,t=0){let n=e.querySelectorAll(`jb-pin-input`)[t];return _(n).toBeTruthy(),_(n.shadowRoot).toBeTruthy(),n}function f(e){let t=Array.from(e.shadowRoot?.querySelectorAll(`.pin-input`)??[]);return _(t.length).toBeGreaterThan(0),t}function p(e){return e.shadowRoot?.querySelector(`.message-box`)?.textContent??``}function m(e,t){let n=Array.from(e.querySelectorAll(`jb-button`)).find(e=>e.textContent?.includes(t));return _(n).toBeTruthy(),n}function h(e){let t=e.shadowRoot?.querySelector(`button`);return _(t).toBeTruthy(),t}function g(e,t){let n=new ClipboardEvent(`paste`,{bubbles:!0,cancelable:!0,clipboardData:new DataTransfer});n.clipboardData?.setData(`text`,t),e.dispatchEvent(n)}var _,v=t((()=>{({expect:_}=__STORYBOOK_MODULE_TEST__)})),y=e({AsyncValidation:()=>I,AutoFocus:()=>A,ChecksumValidation:()=>F,ExplicitNullValueDoesNotFallBackToInitialValue:()=>k,InitialValue:()=>D,InitialValueDoesNotOverrideValue:()=>O,ManualValidation:()=>L,Normal:()=>E,PinInputStyle:()=>R,Required:()=>N,WithError:()=>M,WithValidation:()=>P,__namedExportsOrder:()=>z,charLength:()=>j,default:()=>T}),b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B=t((()=>{b=n(r(),1),o(),c(),l(),v(),x=i(),{expect:S,userEvent:C,waitFor:w}=__STORYBOOK_MODULE_TEST__,T={title:`Components/form elements/JBPinInput`,component:s},E={args:{label:`pin input`,message:`please fill the pin`,value:``},play:async({canvasElement:e})=>{let t=d(e),n=f(t);n[0].focus(),await C.keyboard(`12a3`),await w(()=>{S(t.value).toBe(`123---`),S(n[0].value).toBe(`1`),S(n[1].value).toBe(`2`),S(n[2].value).toBe(`3`),S(t.shadowRoot?.activeElement).toBe(n[3])}),g(n[0],`verification code: 987654`),await w(()=>{S(t.value).toBe(`987654`),S(n.map(e=>e.value).join(``)).toBe(`987654`),S(t.shadowRoot?.activeElement).toBe(n[5])})}},D={render:e=>{let t=(0,b.useRef)(null);return(0,x.jsxs)(`form`,{ref:t,children:[(0,x.jsx)(s,{...e}),(0,x.jsx)(a,{type:`button`,onClick:()=>t.current?.reset(),children:`Reset`})]})},args:{label:`initial value`,initialValue:`123456`},play:async({canvasElement:e,args:t})=>{let n=d(e),r=f(n),i=m(e,`Reset`);await w(()=>{S(n.initialValue).toBe(t.initialValue),S(n.value).toBe(t.initialValue),S(n.isDirty).toBe(!1)}),r[0].focus(),await C.keyboard(`654321`),await w(()=>{S(n.value).toBe(`654321`),S(n.isDirty).toBe(!0)}),n.initialValue=`111111`,S(n.initialValue).toBe(`111111`),S(n.value).toBe(`654321`),S(n.isDirty).toBe(!0),await C.click(h(i)),await w(()=>{S(n.value).toBe(`111111`),S(n.initialValue).toBe(n.value),S(n.isDirty).toBe(!1)}),n.initialValue=`222222`,await w(()=>{S(n.value).toBe(`222222`),S(n.isDirty).toBe(!1)})}},O={args:{initialValue:`123456`,value:`654321`},play:async({canvasElement:e})=>{let t=d(e);await w(()=>{S(t.initialValue).toBe(`123456`),S(t.value).toBe(`654321`),S(t.isDirty).toBe(!0)})}},k={args:{initialValue:`123456`,value:null},play:async({canvasElement:e})=>{let t=d(e);await w(()=>{S(t.initialValue).toBe(`123456`),S(t.value).toBe(`------`),S(t.isDirty).toBe(!0)})}},A={args:{label:`autofocus`,autofocus:!0,value:``},play:async({canvasElement:e})=>{let t=d(e),n=f(t);await w(()=>{S(t.shadowRoot?.activeElement).toBe(n[0])})}},j={args:{label:`8 digit pin`,value:``,charLength:8},play:async({canvasElement:e})=>{let t=d(e);await w(()=>{S(f(t)).toHaveLength(8),S(t.charLength).toBe(8)}),t.charLength=4,await w(()=>{S(f(t)).toHaveLength(4),S(t.charLength).toBe(4),S(t.value).toBe(`----`)})}},M={args:{label:`with error`,message:`simple message`,error:`error message`,value:``},play:async({canvasElement:e,args:t})=>{let n=d(e);S(n.reportValidity()).toBe(!1),await w(()=>{S(p(n)).toBe(t.error),S(f(n).every(e=>e.getAttribute(`aria-invalid`)===`true`)).toBe(!0)}),n.setAttribute(`error`,``),await w(()=>{S(n.reportValidity()).toBe(!0),S(p(n)).toBe(t.message),S(f(n).every(e=>!e.hasAttribute(`aria-invalid`))).toBe(!0)})}},N={args:{label:`required`,required:!0}},P={render:e=>{let t=[{validator:e=>e.startsWith(`1`),message:`PIN must start with 1`}];return(0,x.jsx)(`div`,{children:(0,x.jsx)(s,{...e,validationList:t,onComplete:e=>console.log(`complete`,e),required:!0,onChange:()=>{console.log(`change`)}})})},args:{label:`Verification code`,message:`Enter a code that starts with 1`},play:async({canvasElement:e,args:t})=>{let n=d(e);n.value=`234567`,S(n.reportValidity()).toBe(!1),await w(()=>{S(p(n)).toBe(`PIN must start with 1`),S(f(n).every(e=>e.getAttribute(`aria-invalid`)===`true`)).toBe(!0)}),n.value=`123456`,S(n.reportValidity()).toBe(!0),await w(()=>{S(p(n)).toBe(t.message)})}},F={render:e=>{let t=[{validator:e=>{if(e.includes(`-`))return!0;let t=e.split(``).map(Number);return t.slice(0,-1).reduce((e,t)=>e+t,0)%10===t[t.length-1]},message:`Last digit must match the checksum`}];return(0,x.jsx)(s,{...e,validationList:t,required:!0,onComplete:e=>console.log(`complete`,e)})},args:{label:`Checksum PIN`,charLength:4,message:`Try 1236. The last digit must equal the sum of previous digits modulo 10.`}},I={render:e=>{let t=[{validator:async e=>(await new Promise(e=>setTimeout(e,3e3)),e===`1234`),message:`Only 1234 is accepted`,defer:!0}];return(0,x.jsx)(s,{...e,validationList:t,required:!0,onComplete:e=>console.log(`complete`,e)})},args:{label:`Async verification code`,charLength:4,message:`Enter 1234 and wait 3 seconds for async validation.`},play:async({canvasElement:e,args:t})=>{let n=d(e);n.value=`9999`,S((await n.validation.checkValidity({showError:!0})).isAllValid).toBe(!1),await w(()=>{S(p(n)).toBe(`Only 1234 is accepted`)}),n.value=`1234`,S((await n.validation.checkValidity({showError:!0})).isAllValid).toBe(!0),await w(()=>{S(p(n)).toBe(t.message)})}},L={render:e=>{let t=(0,b.useRef)(null),[n,r]=(0,b.useState)(`Validation has not run yet.`),i=[{validator:e=>e.startsWith(`1`),message:`PIN must start with 1`}],o=()=>{let e=t.current?.reportValidity()??!1,n=t.current?.validationMessage;r(e?`Valid: reportValidity() returned true.`:`Invalid: ${n}`)};return(0,x.jsxs)(`div`,{style:{display:`grid`,gap:`1rem`,maxWidth:`24rem`},children:[(0,x.jsx)(s,{...e,ref:t,validationList:i,required:!0}),(0,x.jsx)(a,{type:`button`,onClick:o,children:`Validate PIN`}),(0,x.jsx)(`p`,{"aria-live":`polite`,children:n})]})},args:{label:`Manual validation code`,charLength:4,message:`Click the button to run reportValidity().`},play:async({canvasElement:e})=>{let t=d(e),n=m(e,`Validate PIN`);await C.click(h(n)),await w(()=>{S(e).toHaveTextContent(`Invalid:`)}),t.value=`1234`,await C.click(h(n)),await w(()=>{S(e).toHaveTextContent(`Valid: reportValidity() returned true.`)})}},R={render:()=>(0,x.jsx)(u,{})},E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
  args: {
    label: 'pin input',
...
}`,...R.parameters?.docs?.source}}},z=[`Normal`,`InitialValue`,`InitialValueDoesNotOverrideValue`,`ExplicitNullValueDoesNotFallBackToInitialValue`,`AutoFocus`,`charLength`,`WithError`,`Required`,`WithValidation`,`ChecksumValidation`,`AsyncValidation`,`ManualValidation`,`PinInputStyle`]}));B();export{I as AsyncValidation,A as AutoFocus,F as ChecksumValidation,k as ExplicitNullValueDoesNotFallBackToInitialValue,D as InitialValue,O as InitialValueDoesNotOverrideValue,L as ManualValidation,E as Normal,R as PinInputStyle,N as Required,M as WithError,P as WithValidation,z as __namedExportsOrder,j as charLength,T as default,B as n,y as t};