import{n as e,g as i,e as c,j as n,b as d,a as l}from"./index-BIaH_qK_.js";import{useMDXComponents as a}from"./index-CSke7xmO.js";import{b as r}from"./index-BjRxPyWZ.js";import"./iframe-BdvQ9nY1.js";import"./index-CEK5zJnf.js";import"./index-C2vOwVL5.js";import"./index-CupGaPSm.js";import"./index-B3ijS-tw.js";import"./index-DrFu-skq.js";function t(s){const o={br:"br",code:"code",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...a(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"Theme/Colors"}),`
`,e.jsx(c,{children:"Color Palette"}),`
`,e.jsx(n,{children:"all color are based on oklch() color space"}),`
`,e.jsx("br",{}),`
`,e.jsxs(d,{children:[e.jsx(l,{title:"single",subtitle:"--jb-black,--jb-white,--jb-highlight",colors:{black:r.single.black.value,white:r.single.white.value,highlight:r.single.highlight.value}}),e.jsx(l,{title:"neutral",subtitle:"--jb-neutral,--jb-neutral-[index]",colors:{main:r.neutral[0].value,d1:r.neutral[1].value,d2:r.neutral[2].value,d3:r.neutral[3].value,d4:r.neutral[4].value,d5:r.neutral[5].value,d6:r.neutral[6].value,d7:r.neutral[7].value,d8:r.neutral[8].value,d9:r.neutral[9].value,d10:r.neutral[10].value}}),e.jsx(l,{title:"primary",subtitle:"--jb-primary,--jb-primary-[name]",colors:{main:r.primary.main.value,"l(lighter)":r.primary.light.value,"d(dark)":r.primary.dark.value,subtle:r.primary.subtle.value,contrast:r.primary.contrast.value,hover:r.primary.hover.value,pressed:r.primary.pressed.value}}),e.jsx(l,{title:"secondary",subtitle:"--jb-secondary,--jb-secondary-[name]",colors:{main:r.secondary.main.value,"l(lighter)":r.secondary.light.value,"d(dark)":r.secondary.dark.value,subtle:r.secondary.subtle.value,contrast:r.secondary.contrast.value,hover:r.secondary.hover.value,pressed:r.secondary.pressed.value}}),e.jsx(l,{title:"success",subtitle:"--jb-green,--jb-green-[name]",colors:{main:r.green.main.value,"l(lighter)":r.green.light.value,"d(dark)":r.green.dark.value,subtle:r.green.subtle.value,contrast:r.green.contrast.value,hover:r.green.hover.value,pressed:r.green.pressed.value}}),e.jsx(l,{title:"error",subtitle:"--jb-red,--jb-red-[name]",colors:{main:r.red.main.value,"l(lighter)":r.red.light.value,"d(dark)":r.red.dark.value,subtle:r.red.subtle.value,contrast:r.red.contrast.value,hover:r.red.hover.value,pressed:r.red.pressed.value}}),e.jsx(l,{title:"warning",subtitle:"--jb-yellow,--jb-yellow-[name]",colors:{main:r.yellow.main.value,"l(lighter)":r.yellow.light.value,"d(dark)":r.yellow.dark.value,subtle:r.yellow.subtle.value,contrast:r.yellow.contrast.value,hover:r.yellow.hover.value,pressed:r.yellow.pressed.value}})]}),`
...
`,"this method currently only support ",e.jsx(o.code,{children:"JBColorGroup"})," color types. for single or neutral colors just use css variables."]})]})}function v(s={}){const{wrapper:o}={...a(),...s.components};return o?e.jsx(o,{...s,children:e.jsx(t,{...s})}):t(s)}export{v as default};
