...
:host{outline:none;display:block}.jb-listbox-web-component{gap:.375rem;display:grid}.label{color:var(--label-color);font-size:var(--label-font-size)}:host(:not([label])) .label{display:none}.list{max-height:var(--max-height);gap:var(--gap);padding:var(--padding);border:var(--border-width) solid var(--border-color);border-bottom-width:var(--border-bottom-width);border-radius:var(--border-radius);background:var(--background);box-shadow:var(--box-shadow);flex-direction:column;transition:all .3s;display:flex;overflow:auto}::slotted(jb-option){display:block}::slotted(jb-option:first-child){border-start-start-radius:var(--option-border-radius);border-start-end-radius:var(--option-border-radius);overflow:hidden}::slotted(jb-option:last-child){border-end-end-radius:var(--option-border-radius);border-end-start-radius:var(--option-border-radius);overflow:hidden}:host(:focus-within) .list{border-width:var(--border-width-focus);border-bottom-width:var(--border-bottom-width-focus);border-color:var(--border-color-focus);box-shadow:var(--box-shadow-focus)}:host(:state(invalid)) .list{border-color:var(--border-color-invalid)}:host(:state(disabled)){cursor:not-allowed;opacity:.6}.message{min-height:1em;color:var(--message-color);font-size:var(--message-font-size)}:host(:state(invalid)) .message{color:var(--message-color-invalid)}</style>
  ...
  `,e.appendChild(t.content.cloneNode(!0)),this.elements={componentWrapper:e.querySelector(`.jb-listbox-web-component`),label:e.querySelector(`.label-text`),list:e.querySelector(`.list`),optionSlot:e.querySelector(`slot`),message:e.querySelector(`.message`)}}#p(){this.addEventListener(`select`,this.#y),this.addEventListener(`deselect`,this.#b),this.addEventListener(`jb-option-connected`,this.#h),this.addEventListener(`keydown`,this.#P),this.elements.optionSlot.addEventListener(`slotchange`,this.#m)}#m=()=>{for(let e of this.elements.optionSlot.assignedElements({flatten:!0}))e.localName===`jb-option`&&this.#g(e);this.#w()};#h=e=>{let t=e.composedPath()[0];t instanceof HTMLElement&&t.localName===`jb-option`&&this.#g(t)};#g(e){this.#t.has(e)||(e.setSelectElement(this),e.addEventListener(`jb-option-disconnected`,this.#_,{once:!0}),e.addEventListener(`mouseenter`,this.#v),e.id||=`jb-listbox-option-${crypto.randomUUID?.()??Math.random().toString(36).slice(2)}`,this.#t.add(e),e.selected=this.#T(e.value))}#_=e=>{let t=e.target;this.#t.delete(t),this.#r.delete(t),this.#n===t&&(this.#n=null),t.removeEventListener(`mouseenter`,this.#v)};#v=e=>{this.disabled||this.#N(e.currentTarget)};#y=e=>{if(this.disabled)return;let t=e.composedPath()[0];if(t.localName!==`jb-option`)return;let n=this.multiple?[...Array.isArray(this.#i)?this.#i:[],t.value]:t.value;this.#o=!0,this.#S(n),this.#N(t),this.#x()};#b=e=>{if(this.disabled||!this.multiple)return;let t=e.composedPath()[0];if(t.localName!==`jb-option`)return;let n=(Array.isArray(this.#i)?this.#i:[]).filter((e=>!Object.is(e,t.value)));this.#o=!0,this.#S(n),this.#N(t),this.#x()};#x(){this.isAutoValidationDisabled||this.#d.checkValidity({showError:this.#e?.states?.has(`invalid`)??!1}),this.dispatchEvent(new Event(`input`,{bubbles:!0,composed:!0})),this.dispatchEvent(new Event(`change`,{bubbles:!0}))}#S(e){this.#i=this.#C(e),this.#w(),this.#E()}#C(e){return this.multiple?e==null?[]:Array.isArray(e)?[...e]:[e]:Array.isArray(e)?e[0]??null:e??null}#w(){this.#n=null,this.#r.clear();for(let e of this.#t){let t=this.#T(e.value);e.selected=t,t&&(this.multiple?this.#r.add(e):this.#n=e)}}#T(e){return Array.isArray(this.#i)?this.#i.some((t=>Object.is(t,e))):Object.is(this.#i,e)}#E(){if(!this.#e||typeof this.#e.setFormValue!=`function`)return;let e=this.#O();if(Array.isArray(this.#i)){if(this.#i.length===0||!this.name)return void this.#e.setFormValue(null,e);let t=new FormData;for(let e of this.#i)t.append(this.name,this.#D(e));this.#e.setFormValue(t,e)}else this.#e.setFormValue(this.#i===null?null:this.#D(this.#i),e)}#D(e){if(typeof e==`string`)return e;if(e instanceof Date)return e.toISOString();if(typeof e==`object`&&e)try{return JSON.stringify(e)}catch{return String(e)}return String(e)}#O(){try{return JSON.stringify({value:this.#i})}catch{return this.#k(this.#i)}}#k(e){return e===null?``:Array.isArray(e)?e.map((e=>this.#D(e))).join(`,`):this.#D(e)}#A(e){return Array.isArray(e)?[...e]:e}#j(e,t){return Array.isArray(e)&&Array.isArray(t)?e.length===t.length&&e.every(((e,n)=>Object.is(e,t[n]))):Object.is(e,t)}get#M(){return[...this.#t].filter((e=>!e.hidden))}#N(e){for(let t of this.#t)t.active=t===e;this.#e&&(this.#e.ariaActiveDescendantElement=e)}#P=e=>{if(this.disabled||this.#F(e.composedPath()[0]))return;let t=this.#M;if(t.length===0)return;let n=t.findIndex((e=>e.active)),r;switch(e.key){case`ArrowDown`:r=t[Math.min(n+1,t.length-1)]||t[0];break;case`ArrowUp`:r=t[n<=0?0:n-1];break;case`Home`:r=t[0];break;case`End`:r=t[t.length-1];break;case`Enter`:case` `:(n>=0?t[n]:t[0]).toggleOption(),e.preventDefault();return;default:return}e.preventDefault(),r&&(this.#N(r),r.scrollIntoView({block:`nearest`}))};#F(e){return e instanceof HTMLElement&&e!==this&&e.matches(`button, input, select, textarea, a[href]`)}#I(){this.tabIndex=this.disabled?-1:0}#L(){let e=[],t=this.getAttribute(`error`)?.trim();return t&&e.push({message:t,stateType:`customError`}),this.required&&e.push({message:w.get(i,`requiredMessage`)(this.getAttribute(`label`)),stateType:`valueMissing`,validator:e=>Array.isArray(e)?e.length>0:e!=null}),e}#R(e){if(e.isAllValid)return void this.#e?.setValidity({});let t={},n=``;for(let r of e.validationList)r.isValid||(t[r.validation.stateType||`customError`]=!0,n||=r.message||``);this.#e?.setValidity(t,n)}},customElements.get(`jb-listbox`)||customElements.define(`jb-listbox`,T)})),D=t((()=>{E(),E()}));function O(e){let t=(0,k.useRef)(null),{children:n,disabled:r,error:i,initialValue:a,label:o,message:s,multiple:c,name:l,onChange:u,onInit:d,onInput:f,onInvalid:p,onLoad:m,ref:h,required:g,validationList:_,value:v,...y}=e;return(0,k.useImperativeHandle)(h,(()=>t.current??void 0),[]),(0,k.useEffect)((()=>{t.current&&(t.current.multiple=c??!1)}),[c]),(0,k.useEffect)((()=>{a!==void 0&&t.current&&(t.current.initialValue=a)}),[a]),(0,k.useEffect)((()=>{v!==void 0&&t.current&&(t.current.value=v)}),[v]),(0,k.useEffect)((()=>{t.current&&(t.current.disabled=r??!1)}),[r]),(0,k.useEffect)((()=>{t.current&&(t.current.required=g??!1)}),[g]),(0,k.useEffect)((()=>{t.current&&(t.current.name=l||``)}),[l]),(0,k.useEffect)((()=>{t.current?.validation&&(t.current.validation.list=_||[])}),[_]),(0,k.useEffect)((()=>{let e=t.current;if(!e)return;let n={error:i,label:o,message:s};for(let[t,r]of Object.entries(n))r==null?e.removeAttribute(t):e.setAttribute(t,r)}),[i,o,s]),(0,k.useEffect)((()=>{let e=t.current;if(!e)return;let n=[[`change`,u],[`init`,d],[`input`,f],[`invalid`,p],[`load`,m]];for(let[t,r]of n)r&&e.addEventListener(t,r);return()=>{for(let[t,r]of n)r&&e.removeEventListener(t,r)}}),[u,d,f,p,m]),k.createElement(`jb-listbox`,{ref:t,...y},n)}var k,A=t((()=>{D(),k=n(r(),1),O.displayName=`JBListbox`})),j=t((()=>{A()})),M=e({FilteredOptions:()=>W,KeyboardSelection:()=>X,MultipleSelection:()=>K,MultipleWithCheckbox:()=>q,Normal:()=>U,RequiredValidation:()=>Y,SingleSelection:()=>G,SingleWithCheckbox:()=>J,__namedExportsOrder:()=>Z,default:()=>H});function N(e){return e.querySelector(`jb-listbox`)}function P(e,t){return e.querySelectorAll(`jb-option`)[t].shadowRoot.querySelector(`.option-content-wrapper`)}var F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q=t((()=>{S(),F=n(r(),1),j(),v(),b(),h(),C(),I=s(),{expect:L,userEvent:R,waitFor:z}=__STORYBOOK_MODULE_TEST__,B=O,x.seed(42),V=x.helpers.multiple(()=>({id:x.string.uuid(),name:x.company.name()}),{count:100}),H={title:`Components/form elements/JBListbox`,component:B,args:{label:`Environment`,name:`environment`},render:e=>(0,I.jsx)(`form`,{children:(0,I.jsxs)(B,{...e,children:[(0,I.jsx)(_,{value:`development`,children:`Development`}),(0,I.jsx)(_,{value:`staging`,children:`Staging`}),(0,I.jsx)(_,{value:`production`,children:`Production`})]})})},U={args:{label:`Select an environment`,message:`Choose one environment`},play:async({canvasElement:e})=>{let t=N(e);await R.click(P(t,1)),await z(()=>{L(t.value).toBe(`staging`),L(t.querySelectorAll(`jb-option`)[1].selected).toBe(!0)})}},W={args:{label:`company`,message:`Type to filter the options`},render:e=>{let[t,n]=(0,F.useState)(``),r=(0,F.useRef)(null);return(0,F.useEffect)(()=>{r.current?.dispatchEvent(new CustomEvent(`filter-change`,{detail:{filterText:t}}))},[t]),(0,I.jsx)(`form`,{children:(0,I.jsxs)(B,{...e,ref:r,children:[(0,I.jsx)(m,{placeholder:`Search Company Here`,value:t,onInput:e=>n(e.target.value),children:(0,I.jsx)(`jb-icon-search`,{slot:`end-section`})}),(0,I.jsx)(`hr`,{style:{margin:`1rem 0`,border:`1px solid #ccc`}}),(0,I.jsx)(`div`,{style:{maxHeight:`400px`,overflowY:`auto`},children:V.map(e=>(0,I.jsx)(_,{value:e.id,children:e.name},e.id))})]})})}},G={args:{initialValue:`staging`},play:async({canvasElement:e})=>{let t=N(e),n=e.querySelector(`form`);await z(()=>L(t.value).toBe(`staging`)),await R.click(P(t,2)),L(t.value).toBe(`production`),L(new FormData(n).get(`environment`)).toBe(`production`),L(t.isDirty).toBe(!0),n.reset(),L(t.value).toBe(`staging`),L(t.isDirty).toBe(!1)}},K={args:{multiple:!0,name:`teams`},render:e=>(0,I.jsx)(`form`,{children:(0,I.jsxs)(B,{...e,children:[(0,I.jsx)(_,{value:`design`,children:`Design`}),(0,I.jsx)(_,{value:`engineering`,children:`Engineering`}),(0,I.jsx)(_,{value:`qa`,children:`QA`})]})}),play:async({canvasElement:e})=>{let t=N(e),n=e.querySelector(`form`);await R.click(P(t,0)),await R.click(P(t,2)),L(t.value).toEqual([`design`,`qa`]),L(new FormData(n).getAll(`teams`)).toEqual([`design`,`qa`]),await R.click(P(t,0)),L(t.value).toEqual([`qa`])}},q={args:{multiple:!0,name:`features`,label:`Features`},render:e=>(0,I.jsx)(`form`,{children:(0,I.jsxs)(B,{...e,children:[(0,I.jsx)(_,{value:`analytics`,children:(0,I.jsx)(y,{label:`Analytics`})}),(0,I.jsx)(_,{value:`notifications`,children:(0,I.jsx)(y,{label:`Notifications`})}),(0,I.jsx)(_,{value:`billing`,children:(0,I.jsx)(y,{label:`Billing`})})]})})},J={args:{name:`plan`,label:`Plan`},render:e=>(0,I.jsx)(`form`,{children:(0,I.jsxs)(B,{...e,children:[(0,I.jsx)(_,{value:`free`,children:(0,I.jsx)(y,{label:`Free`})}),(0,I.jsx)(_,{value:`pro`,children:(0,I.jsx)(y,{label:`Pro`})}),(0,I.jsx)(_,{value:`enterprise`,children:(0,I.jsx)(y,{label:`Enterprise`})})]})}),play:async({canvasElement:e})=>{let t=N(e),n=t.querySelectorAll(`jb-option`)[1].querySelector(`jb-checkbox`);await R.click(n.shadowRoot.querySelector(`.jb-checkbox-web-component`)),L(t.value).toBe(`pro`),L(t.querySelectorAll(`jb-option`)[1].selected).toBe(!0)}},Y={args:{required:!0},play:async({canvasElement:e})=>{let t=N(e);L(t.checkValidity()).toBe(!1),L(t.reportValidity()).toBe(!1),L(t.validationMessage).toBeTruthy(),await R.click(P(t,0)),L(t.checkValidity()).toBe(!0)}},X={play:async({canvasElement:e})=>{let t=N(e);t.focus(),await R.keyboard(`{ArrowDown}{Enter}`),L(t.value).toBe(`staging`)}},U.parameters={...U.parameters,docs:{...U.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...X.parameters?.docs?.source}}},Z=[`Normal`,`FilteredOptions`,`SingleSelection`,`MultipleSelection`,`MultipleWithCheckbox`,`SingleWithCheckbox`,`RequiredValidation`,`KeyboardSelection`]}));Q();export{W as FilteredOptions,X as KeyboardSelection,K as MultipleSelection,q as MultipleWithCheckbox,U as Normal,Y as RequiredValidation,G as SingleSelection,J as SingleWithCheckbox,Z as __namedExportsOrder,H as default,Q as n,M as t};