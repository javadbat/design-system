var V=e=>{throw TypeError(e)};var C=(e,t,s)=>t.has(e)||V("Cannot "+s);var r=(e,t,s)=>(C(e,t,"read from private field"),s?s.call(e):t.get(e)),h=(e,t,s)=>t.has(e)?V("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),l=(e,t,s,i)=>(C(e,t,"write to private field"),i?i.call(e,s):t.set(e,s),s),g=(e,t,s)=>(C(e,t,"access private method"),s);import{R as p,r as o}from"./index-DwQS_Y10.js";import{e as Z}from"./jb-validation-DPnsTO1v.js";import{N as ee}from"./index-bfIR6bpK.js";import{a as te,t as se}from"./index-_b1slotr.js";import{r as w}from"./index-BJ5IkxrY.js";const re=new te({fa:{requireMessage:"سوییچ میبایست فعال شود"},en:{requireMessage:"Switch is required"}});var c,f,d,n,b,v,m,a,$,_,z,K,Q,U,k,ie=(k=class extends HTMLElement{constructor(){super();h(this,a);h(this,c,!1);h(this,f,null);h(this,d,!1);h(this,n);h(this,b,!1);h(this,v,new Z({clearValidationError:this.clearValidationError.bind(this),getValue:()=>this.value,getValidations:g(this,a,U).bind(this),getValueString:()=>this.value?"true":"false",setValidationResult:g(this,a,Q).bind(this),showValidationError:this.showValidationError.bind(this)}));h(this,m,!1);this.initialValue=!1,this.isAutoValidationDisabled=!1,typeof this.attachInternals=="function"&&(l(this,n,this.attachInternals()),r(this,n).role="switch"),this.initWebComponent()}static get formAssociated(){return!0}get value(){return r(this,f)!==null?r(this,f):r(this,c)}set value(t){r(this,c)!==t&&l(this,c,t),g(this,a,K).call(this),r(this,n)&&typeof r(this,n).setFormValue=="function"&&r(this,n).setFormValue(`${t}`)}get isLoading(){return r(this,b)}set isLoading(t){l(this,b,t),t?this.elements.triggerCircleBar.classList.add("--loading"):this.elements.triggerCircleBar.classList.remove("--loading")}get validation(){return r(this,v)}get name(){return this.getAttribute("name")||""}get isDirty(){return r(this,c)!==this.initialValue}set required(t){l(this,m,t),r(this,v).checkValiditySync({showError:!1})}get required(){return r(this,m)}get disabled(){return r(this,d)}set disabled(t){var s,i;l(this,d,t),t?(s=r(this,n).states)==null||s.add("disabled"):(i=r(this,n).states)==null||i.delete("disabled")}connectedCallback(){this.callOnLoadEvent(),this.initProp(),this.callOnInitEvent()}callOnLoadEvent(){const t=new CustomEvent("load",{bubbles:!0,composed:!0});this.dispatchEvent(t)}callOnInitEvent(){const t=new CustomEvent("init",{bubbles:!0,composed:!0});this.dispatchEvent(t)}initWebComponent(){const t=this.attachShadow({mode:"open",delegatesFocus:!0});ee();const s=document.createElement("template");s.innerHTML=`<style>:host(:focus),:host(:focus-visible){outline:none}:host(:dir(rtl)){direction:rtl}:host(:dir(ltr)){direction:ltr}.jb-switch-web-component{flex-direction:row;justify-content:start;align-items:center;gap:.5rem;display:flex}.jb-switch-web-component .caption{color:inherit;transition:all .3s ease-in-out;display:inline-block}.jb-switch-web-component .caption.--active{-webkit-text-stroke:1px;transition:all .3s ease-in-out}.jb-switch-web-component .svg-wrapper{width:71px;height:44px}.jb-switch-web-component .svg-wrapper .switch-svg{width:71px;height:44px}.jb-switch-web-component .svg-wrapper .switch-svg.--active .trigger-button:dir(rtl){transform:translate(280px)}.jb-switch-web-component .svg-wrapper .switch-svg.--active .trigger-button:dir(ltr){transform:translate(0)}.jb-switch-web-component .svg-wrapper .switch-svg.--active .trigger-circle-bar{stroke:var(--ring-color-active)}.jb-switch-web-component .svg-wrapper .switch-svg.--active .bg-bar{fill:var(--bg-color-active)}.jb-switch-web-component .svg-wrapper .switch-svg .bg-bar{fill:var(--bg-color);transition:all .3s ease-in-out}.jb-switch-web-component .svg-wrapper .switch-svg .trigger-button{transition:all .3s ease-in-out}.jb-switch-web-component .svg-wrapper .switch-svg .trigger-button:dir(rtl){transform:translate(0)}.jb-switch-web-component .svg-wrapper .switch-svg .trigger-button:dir(ltr){transform:translate(280px)}.jb-switch-web-component .svg-wrapper .switch-svg .trigger-circle{transition:all .3s ease-in-out}.jb-switch-web-component .svg-wrapper .switch-svg .trigger-circle-bar{fill:#0000;stroke:var(--ring-color);stroke-width:20px;stroke-dasharray:800 800;stroke-dashoffset:0;stroke-linecap:round;transition:all .3s ease-in-out}.jb-switch-web-component .svg-wrapper .switch-svg .trigger-circle-bar.--loading{animation:1.5s ease-in-out infinite jb-switch-loading-dash}@keyframes jb-switch-loading-dash{0%{stroke-dasharray:1 800;stroke-dashoffset:0}50%{stroke-dasharray:600 800;stroke-dashoffset:-600px}to{stroke-dasharray:1 800;stroke-dashoffset:0}} :host{--ring-color-active:var(--jb-switch-ring-color-active,var(--jb-green));--bg-color-active:var(--jb-switch-bg-color-active,var(--jb-green));--bg-color:var(--jb-switch-bg-color,var(--jb-neutral-10));--ring-color:var(--jb-switch-ring-color,var(--jb-primary))}</style>
  ...
  `,t.appendChild(s.content.cloneNode(!0)),this.elements={componentWrapper:t.querySelector(".jb-switch-web-component"),falseText:t.querySelector(".false-text"),trueText:t.querySelector(".true-text"),switch:t.querySelector(".switch-svg"),triggerCircleBar:t.querySelector(".trigger-circle-bar"),triggerButton:t.querySelector(".trigger-button")},this.registerEventListener()}registerEventListener(){this.elements.componentWrapper.addEventListener("click",()=>g(this,a,$).call(this))}initProp(){l(this,d,!1),this.value=this.getAttribute("value")==="true"||!1}static get observedAttributes(){return["true-title","false-title","value","name","disabled"]}attributeChangedCallback(t,s,i){this.onAttributeChange(t,i)}onAttributeChange(t,s){switch(t){case"value":this.value=!!s;break;case"true-title":this.elements.trueText.innerText=s;break;case"false-title":this.elements.falseText.innerText=s;break;case"disabled":s==""||s==="true"?l(this,d,!0):s!="false"&&s!=null&&s!=null||l(this,d,!1)}}focus(){}showValidationError(t){}clearValidationError(){}get validationMessage(){return r(this,n).validationMessage}checkValidity(){return r(this,v).checkValiditySync({showError:!1}).isAllValid}reportValidity(){return r(this,v).checkValiditySync({showError:!0}).isAllValid}},c=new WeakMap,f=new WeakMap,d=new WeakMap,n=new WeakMap,b=new WeakMap,v=new WeakMap,m=new WeakMap,a=new WeakSet,$=function(){if(r(this,d))return;l(this,f,!r(this,c));const t=g(this,a,_).call(this);l(this,f,null),t||(this.value=!r(this,c),g(this,a,z).call(this).defaultPrevented&&(this.value=!r(this,c)))},_=function(){const t=new CustomEvent("before-change",{cancelable:!0});return this.dispatchEvent(t),t.defaultPrevented},z=function(){const t=new Event("change",{bubbles:!0,cancelable:!0,composed:!0});return this.dispatchEvent(t),t},K=function(){this.value?(this.elements.falseText.classList.remove("--active"),this.elements.trueText.classList.add("--active"),this.elements.switch.classList.add("--active")):(this.elements.trueText.classList.remove("--active"),this.elements.falseText.classList.add("--active"),this.elements.switch.classList.remove("--active"))},Q=function(t){if(t.isAllValid)r(this,n).setValidity({},"");else{const s={};let i="";t.validationList.forEach(u=>{u.isValid||(u.validation.stateType&&(s[u.validation.stateType]=!0),i==""&&(i=u.message))}),r(this,n).setValidity(s,i)}},U=function(){return r(this,m)?[{validator:t=>t!==!1,message:re.get(se,"requireMessage")}]:[]},k);customElements.get("jb-switch")||window.customElements.define("jb-switch",ie);let j=p.forwardRef((e,t)=>{let s=o.useRef(null),[i,u]=o.useState(0);return o.useImperativeHandle(t,()=>s?s.current:void 0,[s]),o.useEffect(()=>{u(i+1)},[s.current]),o.useEffect(()=>{s.current&&e.isLoading!==void 0&&e.isLoading!==null&&typeof e.isLoading=="boolean"&&(s.current.isLoading=e.isLoading)},[e.isLoading]),o.useEffect(()=>{s.current&&e.value!==null&&e.value!==void 0&&(s.current.value=e.value)},[e.value]),o.useEffect(()=>{s.current&&typeof e.style=="string"&&s.current.setAttribute("style",e.style)},[e.style]),o.useEffect(()=>{s.current&&typeof e.name=="string"?s.current.setAttribute("name",e.name):s.current&&e.name==null&&s.current.removeAttribute("name")},[e.name]),o.useEffect(()=>{s.current&&Array.isArray(e.validationList)&&(s.current.validation.list=e.validationList)},[e.validationList]),w(s,"load",e.onLoad,!0),w(s,"init",e.onInit,!0),w(s,"change",e.onChange),w(s,"before-change",e.onBeforeChange),p.createElement("jb-switch",{class:e.className?e.className:"","true-title":e.trueTitle?e.trueTitle:"","false-title":e.falseTitle?e.falseTitle:"",ref:s})});j.displayName="JBSwitch";function ae(e){const[t,s]=o.useState(!1);return p.createElement(j,{trueTitle:e.trueTitle,falseTitle:e.falseTitle,value:t,onChange:i=>{s(i.target.value)}})}function ne(e){const[t,s]=o.useState(!1),[i,u]=o.useState(!1);function X(S){const Y=S.target.value;u(!0),setTimeout(()=>{s(Y),u(!1)},1500)}return p.createElement(j,{trueTitle:e.trueTitle,falseTitle:e.falseTitle,value:t,onChange:S=>{X(S)},isLoading:i})}const ge={title:"Components/form elements/JBSwitch",component:j},T={args:{value:!1,trueTitle:"active",falseTitle:"deactivate",onChange:e=>{console.log(e)}}},y={args:{value:!1,trueTitle:"فعال",falseTitle:"غیر فعال",onChange:e=>{console.log(e)}},parameters:{themes:{themeOverride:"rtl"}}},E={render:e=>p.createElement(ae,{...e}),args:{trueTitle:"active",falseTitle:"deactivate"}},L={render:e=>p.createElement(ne,{...e}),args:{trueTitle:"active",falseTitle:"deactivate",value:!1,isLoading:!0,onChange:e=>{console.log(e)}}},x={render:e=>p.createElement("jb-switch",{"true-title":e.trueTitle,"false-title":e.falseTitle}),args:{value:!1,trueTitle:"active",falseTitle:"deactivate",onChange:e=>{console.log(e)}}};var A,B,M;T.parameters={...T.parameters,docs:{...(A=T.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    value: false,
    trueTitle: 'active',
...
}`,...(M=(B=T.parameters)==null?void 0:B.docs)==null?void 0:M.source}}};var q,N,I;y.parameters={...y.parameters,docs:{...(q=y.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    value: false,
    trueTitle: 'فعال',
    falseTitle: 'غیر فعال',
...
}`,...(I=(N=y.parameters)==null?void 0:N.docs)==null?void 0:I.source}}};var O,J,R;E.parameters={...E.parameters,docs:{...(O=E.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render: args => <JBSwitchTest {...args} />,
  args: {
    trueTitle: 'active',
    falseTitle: 'deactivate'
  }
}`,...(R=(J=E.parameters)==null?void 0:J.docs)==null?void 0:R.source}}};var W,F,G;L.parameters={...L.parameters,docs:{...(W=L.parameters)==null?void 0:W.docs,source:{originalSource:`{
...
}`,...(G=(F=L.parameters)==null?void 0:F.docs)==null?void 0:G.source}}};var P,D,H;x.parameters={...x.parameters,docs:{...(P=x.parameters)==null?void 0:P.docs,source:{originalSource:`{
...
}`,...(H=(D=x.parameters)==null?void 0:D.docs)==null?void 0:H.source}}};const fe=["Normal","RTL","ActionTest","LoadingActionTest","WebComponent"];export{E as ActionTest,L as LoadingActionTest,T as Normal,y as RTL,x as WebComponent,fe as __namedExportsOrder,ge as default};
