import{i as e}from"./preload-helper-CT_b8DTk.js";import{t}from"./iframe-CKFpjfZi.js";import{f as n,h as r,j as i,p as a,v as o,y as s}from"./blocks-DMsn289S.js";import{t as c}from"./mdx-react-shim-9EA0vkyW.js";import{CustomSelectedValueRender as l,n as u,t as d}from"./JBSelect.stories-EbzGXBlX.js";function f(e){let t={code:`code`,h2:`h2`,h3:`h3`,p:`p`,pre:`pre`,...i(),...e.components};return(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(n,{of:d}),`
`,(0,m.jsx)(o,{children:`Custom selected value content`}),`
...
`,(0,m.jsx)(t.pre,{children:(0,m.jsx)(t.code,{className:`language-tsx`,children:`import { JBSelect } from 'jb-select/react';
...
`,(0,m.jsxs)(t.p,{children:[(0,m.jsx)(t.code,{children:`getSelectedValueDOM`}),` customises a single selected value. It is not currently supported for `,(0,m.jsx)(t.code,{children:`multiple`}),` selects, whose selected value is an array. For multiple selection, use the component's default selected-value display.`]})]})}function p(e={}){let{wrapper:t}={...i(),...e.components};return t?(0,m.jsx)(t,{...e,children:(0,m.jsx)(f,{...e})}):f(e)}var m;e((()=>{m=t(),c(),s(),u()}))();export{p as default};