...
}`,...(K=(D=O.parameters)==null?void 0:D.docs)==null?void 0:K.source}}};var q,P,F;x.parameters={...x.parameters,docs:{...(q=x.parameters)==null?void 0:q.docs,source:{originalSource:`{
  render: story => {
    const [isOpen, setIsOpen] = useState(false);
...
}`,...(F=(P=x.parameters)==null?void 0:P.docs)==null?void 0:F.source}}};var Y,G,Q;j.parameters={...j.parameters,docs:{...(Y=j.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  render: () => {
    const [isOpen, setIsOpen] = useState(false);
    return <div>
...
}`,...(Q=(G=j.parameters)==null?void 0:G.docs)==null?void 0:Q.source}}};const ye=["Normal","WithLargeContent","ActionTest","MobileView","CloseDetail","CustomizedUi"];export{C as ActionTest,x as CloseDetail,j as CustomizedUi,O as MobileView,y as Normal,E as WithLargeContent,ye as __namedExportsOrder,ke as default};
