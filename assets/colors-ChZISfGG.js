import{i as e}from"./preload-helper-CT_b8DTk.js";import{t}from"./iframe-ggKXR4rT.js";import{_ as n,d as r,h as i,i as a,k as o,l as s,r as c}from"./blocks-CLyHj7Mb.js";import{t as l}from"./mdx-react-shim-Ob8i-TrQ.js";import{n as u,r as d}from"./dist-Difvyw-t.js";function f(e){let t={br:`br`,code:`code`,h2:`h2`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...o(),...e.components};return(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(r,{title:`Theme/Colors`}),`
`,(0,m.jsx)(s,{children:`Color Palette`}),`
`,(0,m.jsx)(i,{children:`all color are based on oklch() color space`}),`
`,(0,m.jsx)(`br`,{}),`
`,(0,m.jsxs)(a,{children:[(0,m.jsx)(c,{title:`single`,subtitle:`--jb-black,--jb-white,--jb-highlight`,colors:{black:u.single.black.value,white:u.single.white.value,highlight:u.single.highlight.value}}),(0,m.jsx)(c,{title:`neutral`,subtitle:`--jb-neutral,--jb-neutral-[index]`,colors:{main:u.neutral[0].value,d1:u.neutral[1].value,d2:u.neutral[2].value,d3:u.neutral[3].value,d4:u.neutral[4].value,d5:u.neutral[5].value,d6:u.neutral[6].value,d7:u.neutral[7].value,d8:u.neutral[8].value,d9:u.neutral[9].value,d10:u.neutral[10].value}}),(0,m.jsx)(c,{title:`primary`,subtitle:`--jb-primary,--jb-primary-[name]`,colors:{main:u.primary.main.value,"l(lighter)":u.primary.light.value,"d(dark)":u.primary.dark.value,subtle:u.primary.subtle.value,contrast:u.primary.contrast.value,hover:u.primary.hover.value,pressed:u.primary.pressed.value}}),(0,m.jsx)(c,{title:`secondary`,subtitle:`--jb-secondary,--jb-secondary-[name]`,colors:{main:u.secondary.main.value,"l(lighter)":u.secondary.light.value,"d(dark)":u.secondary.dark.value,subtle:u.secondary.subtle.value,contrast:u.secondary.contrast.value,hover:u.secondary.hover.value,pressed:u.secondary.pressed.value}}),(0,m.jsx)(c,{title:`success`,subtitle:`--jb-green,--jb-green-[name]`,colors:{main:u.green.main.value,"l(lighter)":u.green.light.value,"d(dark)":u.green.dark.value,subtle:u.green.subtle.value,contrast:u.green.contrast.value,hover:u.green.hover.value,pressed:u.green.pressed.value}}),(0,m.jsx)(c,{title:`error`,subtitle:`--jb-red,--jb-red-[name]`,colors:{main:u.red.main.value,"l(lighter)":u.red.light.value,"d(dark)":u.red.dark.value,subtle:u.red.subtle.value,contrast:u.red.contrast.value,hover:u.red.hover.value,pressed:u.red.pressed.value}}),(0,m.jsx)(c,{title:`warning`,subtitle:`--jb-yellow,--jb-yellow-[name]`,colors:{main:u.yellow.main.value,"l(lighter)":u.yellow.light.value,"d(dark)":u.yellow.dark.value,subtle:u.yellow.subtle.value,contrast:u.yellow.contrast.value,hover:u.yellow.hover.value,pressed:u.yellow.pressed.value}})]}),`
...
`,`this method currently only support `,(0,m.jsx)(t.code,{children:`JBColorGroup`}),` color types. for single or neutral colors just use css variables.`]})]})}function p(e={}){let{wrapper:t}={...o(),...e.components};return t?(0,m.jsx)(t,{...e,children:(0,m.jsx)(f,{...e})}):f(e)}var m;e((()=>{m=t(),l(),n(),d()}))();export{p as default};