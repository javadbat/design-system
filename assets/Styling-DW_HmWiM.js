import{i as e}from"./preload-helper-CT_b8DTk.js";import{t}from"./iframe-BJZP98JJ.js";import{f as ee,h as n,j as r,p as i,v as te,y as a}from"./blocks-28IqVyiG.js";import{t as o}from"./mdx-react-shim-MhT3IHHe.js";import{a as s,c,d as l,h as u,i as d,l as f,m as p,n as m,o as h,p as g,r as _,s as v,t as y,u as b}from"./Styles.stories-CoVkqO8F.js";import{C as x,S as ne,_ as re,a as ie,b as ae,c as oe,d as se,f as ce,g as le,h as ue,i as de,l as S,m as C,n as w,o as T,p as E,r as D,s as O,t as k,u as A,v as j,w as M,x as N,y as P}from"./terminal-Ci83lsF2.js";var F,I=e((()=>{F=`jb-modal.ant-design-style {
  --jb-modal-bg-color: var(--jb-surface-primary);
...
jb-modal.ant-design-style::part(content) {
  box-shadow: 0 0.375rem 1rem rgb(0 0 0 / 0.14);
}

jb-modal.ant-design-style:state(open)::part(content) {
...
jb-modal.aurora-style::part(content) {
...
jb-modal.aurora-style jb-button.aurora-style[color="light"] {
  --jb-button-color: var(--jb-content-secondary);
...
jb-modal.aurora-style:state(open)::part(content) {
...
`})),z,B=e((()=>{z=`jb-modal.bootstrap-style {
  --jb-modal-bg-color: var(--jb-surface-primary);
...
jb-modal.bootstrap-style::part(content) {
  border: 1px solid rgb(0 0 0 / 0.18);
  box-shadow: 0 0.5rem 1rem rgb(0 0 0 / 0.15);
}

jb-modal.bootstrap-style:state(open)::part(content) {
...
jb-modal.candy-style::part(content) {
  border: 1px solid #f9a8d4;
  box-shadow: 0 1rem 2.25rem rgb(244 114 182 / 0.22);
}

jb-modal.candy-style:state(open)::part(content) {
...
`})),U,fe=e((()=>{U=`jb-modal.carbon-style {
  --jb-modal-bg-color: var(--jb-surface-primary);
...
jb-modal.carbon-style::part(content) {
...
jb-modal.carbon-style jb-button[color="light"] {
  ...
  --jb-button-color-hover: var(--jb-content-inverse);
...
jb-modal.carbon-style jb-button[color="secondary"] {
  --jb-button-secondary: var(--jb-content-primary);
}

jb-modal.carbon-style:state(open)::part(content) {
...
`})),W,pe=e((()=>{W=`jb-modal.cupertino-style {
...
jb-modal.cupertino-style::part(content) {
  border: 1px solid rgb(60 60 67 / 0.14);
  box-shadow: 0 1.5rem 3rem rgb(0 0 0 / 0.18);
}

jb-modal.cupertino-style:state(open)::part(content) {
...
`})),G,me=e((()=>{G=`jb-modal.fluent-style {
  --jb-modal-bg-color: var(--jb-content-inverse);
...
jb-modal.fluent-style::part(content) {
  border: 1px solid var(--jb-surface-hover);
  box-shadow: 0 0.75rem 1.5rem rgb(0 0 0 / 0.18);
}

jb-modal.fluent-style:state(open)::part(content) {
...
`})),K,he=e((()=>{K=`jb-modal.forest-style {
...
`})),q,ge=e((()=>{q=`jb-modal.material-style {
  --jb-modal-bg-color: var(--jb-surface-primary);
...
jb-modal.material-style::part(content) {
  border: 1px solid var(--jb-outline-variant);
  box-shadow: var(--jb-elevation-3);
}

jb-modal.material-style:state(open)::part(content) {
...
`})),J,Y=e((()=>{J=`jb-modal.porcelain-style {
  --jb-modal-bg-color: var(--jb-surface-primary);
...
jb-modal.porcelain-style::part(content) {
  border: 1px solid #d6e4f0;
  box-shadow: 0 1.25rem 2.5rem rgb(47 128 237 / 0.16);
}

jb-modal.porcelain-style:state(open)::part(content) {
...
jb-modal.terminal-style::part(content) {
  border: 1px solid #22c55e;
  box-shadow: 0 0 0 1px #22c55e, 0 1rem 2rem rgb(0 0 0 / 0.4);
}

jb-modal.terminal-style:state(open)::part(content) {
...
`}));function Q(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,h4:`h4`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,ul:`ul`,...r(),...e.components};return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(ee,{title:`Components/JBModal/Styling`}),`
...
`,(0,$.jsxs)(t.li,{children:[`Public component variables use `,(0,$.jsx)(t.code,{children:`--jb-modal-*`}),` on `,(0,$.jsx)(t.code,{children:`jb-modal`}),`; official parts use `,(0,$.jsx)(t.code,{children:`::part(root)`}),`, `,(0,$.jsx)(t.code,{children:`::part(background)`}),`, and `,(0,$.jsx)(t.code,{children:`::part(content)`}),`.`]}),`
...
`,(0,$.jsxs)(t.li,{children:[`Use `,(0,$.jsx)(t.code,{children:`::part(content)`}),` for border, shadow, content sizing, and entrance motion.`]}),`
`,(0,$.jsxs)(t.li,{children:[`Use the `,(0,$.jsx)(t.code,{children:`open`}),` custom state for motion selectors such as `,(0,$.jsx)(t.code,{children:`jb-modal:state(open)::part(content)`}),`.`]}),`
...
`,(0,$.jsxs)(`table`,{children:[(0,$.jsx)(`thead`,{children:(0,$.jsxs)(`tr`,{children:[(0,$.jsx)(`th`,{children:`Part`}),(0,$.jsx)(`th`,{children:`Element`}),(0,$.jsx)(`th`,{children:`Notes`})]})}),(0,$.jsxs)(`tbody`,{children:[(0,$.jsxs)(`tr`,{children:[(0,$.jsx)(`td`,{children:(0,$.jsx)(`code`,{children:`root`})}),(0,$.jsx)(`td`,{children:`Fullscreen modal root.`}),(0,$.jsx)(`td`,{children:`Use carefully for advanced layout, preview rendering, or whole-modal effects.`})]}),(0,$.jsxs)(`tr`,{children:[(0,$.jsx)(`td`,{children:(0,$.jsx)(`code`,{children:`background`})}),(0,$.jsx)(`td`,{children:`Backdrop element.`}),(0,$.jsx)(`td`,{children:`Use for backdrop color, blur, opacity, and backdrop animation.`})]}),(0,$.jsxs)(`tr`,{children:[(0,$.jsx)(`td`,{children:(0,$.jsx)(`code`,{children:`content`})}),(0,$.jsx)(`td`,{children:`Modal content box.`}),(0,$.jsx)(`td`,{children:`Use for border, shadow, content box sizing, and content animation.`})]})]})]}),`
`,(0,$.jsxs)(`table`,{children:[(0,$.jsx)(`thead`,{children:(0,$.jsxs)(`tr`,{children:[(0,$.jsx)(`th`,{children:`Custom State`}),(0,$.jsx)(`th`,{children:`Meaning`}),(0,$.jsx)(`th`,{children:`Example Selector`})]})}),(0,$.jsx)(`tbody`,{children:(0,$.jsxs)(`tr`,{children:[(0,$.jsx)(`td`,{children:(0,$.jsx)(`code`,{children:`open`})}),(0,$.jsx)(`td`,{children:`Applied while the modal is open.`}),(0,$.jsx)(`td`,{children:(0,$.jsx)(`code`,{children:`jb-modal:state(open)::part(content)`})})]})})]}),`
...
`,(0,$.jsx)(t.pre,{children:(0,$.jsx)(t.code,{className:`language-css`,children:`jb-modal.brand-modal {\r
  --jb-modal-bg-color: #ffffff;\r
  --jb-modal-back-bg-color: rgb(15 23 42 / 0.48);\r
  --jb-modal-border-radius: 1rem;\r
  --jb-modal-z-index: 1000;\r
}\r
\r
jb-modal.brand-modal::part(background) {\r
  backdrop-filter: blur(0.5rem);\r
}\r
\r
jb-modal.brand-modal::part(content) {\r
  border: 1px solid #dbeafe;\r
  box-shadow: 0 1.25rem 2.5rem rgb(15 23 42 / 0.16);\r
}\r
\r
jb-modal.brand-modal:state(open)::part(content) {\r
  animation: brand-modal-in 180ms ease-out;\r
}\r
\r
@keyframes brand-modal-in {\r
  from {\r
    opacity: 0;\r
    transform: translateY(0.75rem);\r
  }\r
}
`})}),`
...
\r
/* https://github.com/javadbat/design-system/blob/main/modules/jb-modal/stories/styles/style-carbon.css */\r
jb-modal.theme-name-modal {\r
  /* modal host variables */\r
}\r
\r
jb-modal.theme-name-modal::part(background) {\r
  /* backdrop treatment */\r
}\r
\r
jb-modal.theme-name-modal::part(content) {\r
  /* modal surface treatment */\r
}\r
\r
jb-modal.theme-name-modal:state(open)::part(content) {\r
  /* open-state motion */\r
}\r
\r
jb-button.theme-name-button {\r
  /* imported from the JBButton recipe, not duplicated here */\r
}
`})}),`
`,(0,$.jsxs)(t.p,{children:[`This keeps common theme tokens reusable while making the `,(0,$.jsx)(t.code,{children:`JBModal`}),` styling API visible in one page.`]})]})}function ye(e={}){let{wrapper:t}={...r(),...e.components};return t?(0,$.jsx)(t,{...e,children:(0,$.jsx)(Q,{...e})}):Q(e)}var $;e((()=>{$=t(),o(),a(),u(),M(),ne(),ae(),j(),le(),C(),ce(),A(),O(),ie(),D(),k(),I(),R(),B(),H(),fe(),pe(),me(),he(),ge(),Y(),_e(),ve()}))();export{ye as default};