import{i as e}from"./preload-helper-CT_b8DTk.js";import{t}from"./iframe-GXxEDj8I.js";import{f as n,h as r,j as i,o as a,p as o,y as s}from"./blocks-jzSyhOK7.js";import{t as c}from"./mdx-react-shim-DTB0SW4F.js";import{ArrayValue as l,FormWithSameName as u,n as d}from"./JBForm.stories-CF13SuP5.js";function f(e){let t={blockquote:`blockquote`,br:`br`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,...i(),...e.components};return(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(n,{title:`Components/form elements/JBForm/ValueCollection`}),`
...
`,(0,m.jsxs)(t.p,{children:[`Most `,(0,m.jsx)(t.code,{children:`jb-form`}),` methods return their result by traversing all form elements, sub-forms and virtual elements. we create result base on each field `,(0,m.jsx)(t.code,{children:`name`}),` attribute.\r
for example when you call `,(0,m.jsx)(t.code,{children:`form.getFormValues()`}),` you will get following result:`]}),`
`,(0,m.jsx)(t.pre,{children:(0,m.jsx)(t.code,{className:`language-js`,children:`{\r
  bookName:'wiki',\r
  price:1000\r
}
`})}),`
`,(0,m.jsx)(t.p,{children:`but when we have form with multiple form field with the same name like this:`}),`
`,(0,m.jsx)(t.pre,{children:(0,m.jsx)(t.code,{className:`language-html`,children:`<jb-form>\r
  <jb-input name="personName" />\r
  <jb-input name="phoneNumber" />\r
  <jb-input name="phoneNumber" />\r
  <jb-input name="phoneNumber" />\r
</jb-form>
`})}),`
...
`,(0,m.jsx)(t.pre,{children:(0,m.jsx)(t.code,{className:`language-js`,children:`{\r
  personName:'john',\r
  phoneNumber:new TraverseCollection([[1,'0912999999999'],[2,'0912888888888'],[3,'091277777777']])\r
}
`})}),`
...
`,(0,m.jsx)(t.pre,{children:(0,m.jsx)(t.code,{className:`language-html`,children:`<jb-form name="mainForm">\r
  <jb-form name="person">\r
    <jb-input name="personName" />\r
    <jb-input name="age" />\r
  </jb-form>\r
  <jb-form name="person">\r
...
`,(0,m.jsxs)(t.p,{children:[`if your element has a `,(0,m.jsx)(t.code,{children:`id`}),` we will use that id as a `,(0,m.jsx)(t.code,{children:`Map`}),` key so:\r
`,(0,m.jsx)(t.code,{children:`[1,'0912999999999']`}),` will become `,(0,m.jsx)(t.code,{children:`['YourId','0912999999999']`}),`.\r
...
`,(0,m.jsxs)(t.p,{children:[`first we develop this feature with Array because it easier to use and need no transformation for send it or store it as a JSON.\r
...
`,(0,m.jsx)(r,{of:l}),`
`,(0,m.jsx)(a,{of:l}),`
`,(0,m.jsx)(o,{of:l})]})}function p(e={}){let{wrapper:t}={...i(),...e.components};return t?(0,m.jsx)(t,{...e,children:(0,m.jsx)(f,{...e})}):f(e)}var m;e((()=>{m=t(),c(),s(),d()}))();export{p as default};