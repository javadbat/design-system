import{i as e}from"./preload-helper-CT_b8DTk.js";import{t}from"./iframe-CKFpjfZi.js";import{a as n,f as r,g as i,i as a,j as o,u as s,y as c}from"./blocks-DMsn289S.js";import{t as l}from"./mdx-react-shim-9EA0vkyW.js";import{n as u,t as d}from"./dist-COPX3L6A.js";function f(e){let t={br:`br`,code:`code`,h2:`h2`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...o(),...e.components};return(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(r,{title:`Theme/Colors`}),`
`,(0,m.jsx)(s,{children:`Color Palette`}),`
`,(0,m.jsx)(i,{children:`all color are based on oklch() color space`}),`
`,(0,m.jsx)(`br`,{}),`
`,(0,m.jsxs)(n,{children:[(0,m.jsx)(a,{title:`single`,subtitle:`--jb-black,--jb-white,--jb-highlight`,colors:{black:d.single.black.value,white:d.single.white.value,highlight:d.single.highlight.value}}),(0,m.jsx)(a,{title:`neutral`,subtitle:`--jb-neutral,--jb-neutral-[index]`,colors:{main:d.neutral[0].value,d1:d.neutral[1].value,d2:d.neutral[2].value,d3:d.neutral[3].value,d4:d.neutral[4].value,d5:d.neutral[5].value,d6:d.neutral[6].value,d7:d.neutral[7].value,d8:d.neutral[8].value,d9:d.neutral[9].value,d10:d.neutral[10].value}}),(0,m.jsx)(a,{title:`primary`,subtitle:`--jb-primary,--jb-primary-[name]`,colors:{main:d.primary.main.value,"l(lighter)":d.primary.light.value,"d(dark)":d.primary.dark.value,subtle:d.primary.subtle.value,contrast:d.primary.contrast.value,hover:d.primary.hover.value,pressed:d.primary.pressed.value}}),(0,m.jsx)(a,{title:`secondary`,subtitle:`--jb-secondary,--jb-secondary-[name]`,colors:{main:d.secondary.main.value,"l(lighter)":d.secondary.light.value,"d(dark)":d.secondary.dark.value,subtle:d.secondary.subtle.value,contrast:d.secondary.contrast.value,hover:d.secondary.hover.value,pressed:d.secondary.pressed.value}}),(0,m.jsx)(a,{title:`success`,subtitle:`--jb-green,--jb-green-[name]`,colors:{main:d.green.main.value,"l(lighter)":d.green.light.value,"d(dark)":d.green.dark.value,subtle:d.green.subtle.value,contrast:d.green.contrast.value,hover:d.green.hover.value,pressed:d.green.pressed.value}}),(0,m.jsx)(a,{title:`error`,subtitle:`--jb-red,--jb-red-[name]`,colors:{main:d.red.main.value,"l(lighter)":d.red.light.value,"d(dark)":d.red.dark.value,subtle:d.red.subtle.value,contrast:d.red.contrast.value,hover:d.red.hover.value,pressed:d.red.pressed.value}}),(0,m.jsx)(a,{title:`warning`,subtitle:`--jb-yellow,--jb-yellow-[name]`,colors:{main:d.yellow.main.value,"l(lighter)":d.yellow.light.value,"d(dark)":d.yellow.dark.value,subtle:d.yellow.subtle.value,contrast:d.yellow.contrast.value,hover:d.yellow.hover.value,pressed:d.yellow.pressed.value}})]}),`
`,(0,m.jsx)(i,{children:`Semantic color tokens`}),`
`,(0,m.jsxs)(t.p,{children:[`Semantic color tokens describe how a color is used instead of how it looks. Content tokens represent foreground content such as text, icons, and SVG strokes. Components should prefer semantic tokens over primitive tokens such as `,(0,m.jsx)(t.code,{children:`--jb-black`}),` or `,(0,m.jsx)(t.code,{children:`--jb-neutral-7`}),`. This keeps component styles independent from the primitive palette and makes theme changes easier.`]}),`
`,(0,m.jsx)(t.p,{children:`The default semantic tokens are aliases of primitive colors, so changing a primitive also updates every semantic token that references it.`}),`
`,(0,m.jsxs)(`table`,{children:[(0,m.jsx)(`thead`,{children:(0,m.jsxs)(`tr`,{children:[(0,m.jsx)(`th`,{children:`Token`}),(0,m.jsx)(`th`,{children:`Default primitive`}),(0,m.jsx)(`th`,{children:`Intended use`})]})}),(0,m.jsxs)(`tbody`,{children:[(0,m.jsxs)(`tr`,{children:[(0,m.jsx)(`td`,{children:(0,m.jsx)(`code`,{children:`--jb-content-primary`})}),(0,m.jsx)(`td`,{children:(0,m.jsx)(`code`,{children:`--jb-black`})}),(0,m.jsx)(`td`,{children:`Primary text, labels, and high-emphasis content`})]}),(0,m.jsxs)(`tr`,{children:[(0,m.jsx)(`td`,{children:(0,m.jsx)(`code`,{children:`--jb-content-secondary`})}),(0,m.jsx)(`td`,{children:(0,m.jsx)(`code`,{children:`--jb-neutral-7`})}),(0,m.jsx)(`td`,{children:`Supporting text, descriptions, and lower-emphasis content`})]}),(0,m.jsxs)(`tr`,{children:[(0,m.jsx)(`td`,{children:(0,m.jsx)(`code`,{children:`--jb-content-inverse`})}),(0,m.jsx)(`td`,{children:(0,m.jsx)(`code`,{children:`--jb-white`})}),(0,m.jsx)(`td`,{children:`Text displayed on an inverse or dark surface`})]}),(0,m.jsxs)(`tr`,{children:[(0,m.jsx)(`td`,{children:(0,m.jsx)(`code`,{children:`--jb-surface-primary`})}),(0,m.jsx)(`td`,{children:(0,m.jsx)(`code`,{children:`--jb-white`})}),(0,m.jsx)(`td`,{children:`Main page and component surfaces`})]}),(0,m.jsxs)(`tr`,{children:[(0,m.jsx)(`td`,{children:(0,m.jsx)(`code`,{children:`--jb-surface-secondary`})}),(0,m.jsx)(`td`,{children:(0,m.jsx)(`code`,{children:`--jb-neutral-10`})}),(0,m.jsx)(`td`,{children:`Secondary or visually separated surfaces`})]}),(0,m.jsxs)(`tr`,{children:[(0,m.jsx)(`td`,{children:(0,m.jsx)(`code`,{children:`--jb-surface-inverse`})}),(0,m.jsx)(`td`,{children:(0,m.jsx)(`code`,{children:`--jb-black`})}),(0,m.jsx)(`td`,{children:`Surfaces that invert the default light theme`})]})]})]}),`
`,(0,m.jsx)(t.p,{children:`Use semantic tokens in component styles:`}),`
`,(0,m.jsx)(t.pre,{children:(0,m.jsx)(t.code,{className:`language-css`,children:`.card {
  color: var(--jb-content-primary);
  background-color: var(--jb-surface-primary);
}
...
.card--inverse {
  color: var(--jb-content-inverse);
  background-color: var(--jb-surface-inverse);
}
`})}),`
`,(0,m.jsx)(t.p,{children:`To change the palette while preserving the default semantic relationships, override the primitive tokens:`}),`
`,(0,m.jsx)(t.pre,{children:(0,m.jsx)(t.code,{className:`language-css`,children:`:root {
  --jb-black: oklch(0.2 0.02 258);
  --jb-white: oklch(0.98 0.005 258);
  --jb-neutral-7: oklch(0.55 0.015 258);
  --jb-neutral-10: oklch(0.94 0.008 258);
}
`})}),`
`,(0,m.jsx)(t.p,{children:`You can also remap semantic roles within a specific theme or application section:`}),`
`,(0,m.jsx)(t.pre,{children:(0,m.jsx)(t.code,{className:`language-css`,children:`.dark-theme {
  --jb-content-primary: var(--jb-white);
  --jb-content-secondary: var(--jb-neutral-8);
  --jb-content-inverse: var(--jb-black);
  --jb-surface-primary: var(--jb-black);
  --jb-surface-secondary: var(--jb-neutral-1);
  --jb-surface-inverse: var(--jb-white);
}
`})}),`
`,(0,m.jsx)(t.p,{children:`When adding component variables, keep a component-level override first and a semantic token as its default:`}),`
`,(0,m.jsx)(t.pre,{children:(0,m.jsx)(t.code,{className:`language-css`,children:`:host {
  --label-color: var(--jb-input-label-color, var(--jb-content-primary));
}
`})}),`
`,(0,m.jsx)(i,{children:`Customize Component colors`}),`
...
`})}),`
`,(0,m.jsx)(i,{children:`Color Rules`}),`
...
`]})]}),`
`,(0,m.jsx)(`br`,{}),`
`,(0,m.jsx)(i,{children:`Define custom colors`}),`
`,(0,m.jsx)(`br`,{}),`
...
`,`this method currently only support `,(0,m.jsx)(t.code,{children:`JBColorGroup`}),` color types. for single or neutral colors just use css variables.`]})]})}function p(e={}){let{wrapper:t}={...o(),...e.components};return t?(0,m.jsx)(t,{...e,children:(0,m.jsx)(f,{...e})}):f(e)}var m;e((()=>{m=t(),l(),c(),u()}))();export{p as default};